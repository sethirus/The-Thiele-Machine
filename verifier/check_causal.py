#!/usr/bin/env python3
"""CLI wrapper for C-CAUSAL receipt-defined verification."""
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("run_dir", type=Path, help="Run directory containing causal artifacts")
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        result = verify_causal(args.run_dir, args.trust_manifest)
        status = "PASS"
        ok = True
        err: str | None = None
    ...
    module = "C_causal"
    receipt_name = "causal.receipt.json"
    ...
    verification_payload = {
        ...
        "metadata": {
            "generated_by": "verifier/check_causal.py",
            "timestamp": None,
            "error": err,
        },
    }
