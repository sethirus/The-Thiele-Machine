#!/usr/bin/env python3
"""CLI wrapper for C-RAND receipt-defined verification."""
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("run_dir", type=Path, help="Run directory containing randomness artifacts")
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        result = verify_randomness(args.run_dir, args.trust_manifest)
        status = "PASS"
        ok = True
        err: str | None = None
    ...
    module = "C_randomness"
    receipt_name = "randomness.receipt.json"
    ...
    verification_payload = {
        ...
        "metadata": {
            "generated_by": "verifier/check_randomness.py",
            "timestamp": None,
            "error": err,
        },
    }
