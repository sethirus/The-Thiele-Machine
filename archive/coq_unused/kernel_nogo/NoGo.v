(** * NoGo: Minimal no-go theorems for weight uniqueness

    WHY THIS FILE EXISTS:
    I claim the weight laws (empty, sequential, disjoint_commutes) from
    Definitions.v are NOT sufficient to uniquely determine mu-cost. There
    ...
    THE PROOF STRATEGY:
    Construct w_scale(k)(t) = k * length(t) for any k in nat. This family has:
    ...
    WHY THIS MATTERS:
    This proves mu-cost is NOT derivable from locality/additivity alone. You
