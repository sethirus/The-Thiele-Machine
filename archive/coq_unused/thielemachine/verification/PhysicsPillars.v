(** =========================================================================
    ...
    primary audited symmetry anchors. For the active manifest-aligned results, see:
    - coq/kernel/KernelPhysics.v (kernel_conservation_mu_gauge)
    - coq/kernel/KernelPhysics.v (nat_action_composition)
    
    These are the current symmetry anchors referenced by INQUISITOR_ASSUMPTIONS.json.
    ========================================================================= *)
