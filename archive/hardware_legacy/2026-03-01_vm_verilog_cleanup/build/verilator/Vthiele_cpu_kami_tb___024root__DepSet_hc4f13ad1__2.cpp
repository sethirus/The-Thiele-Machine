...
void Vthiele_cpu_kami_tb___024root___nba_sequent__TOP__0(Vthiele_cpu_kami_tb___024root* vlSelf);
void Vthiele_cpu_kami_tb___024root___nba_comb__TOP__0(Vthiele_cpu_kami_tb___024root* vlSelf);
...
void Vthiele_cpu_kami_tb___024root___eval_nba(Vthiele_cpu_kami_tb___024root* vlSelf) {
    ...
    if ((1ULL & vlSelf->__VnbaTriggered.word(0U))) {
        Vthiele_cpu_kami_tb___024root___nba_sequent__TOP__0(vlSelf);
    }
    if ((7ULL & vlSelf->__VnbaTriggered.word(0U))) {
        Vthiele_cpu_kami_tb___024root___nba_comb__TOP__0(vlSelf);
...
void Vthiele_cpu_kami_tb___024root___timing_resume(Vthiele_cpu_kami_tb___024root* vlSelf) {
    ...
    if ((1ULL & vlSelf->__VactTriggered.word(0U))) {
        vlSelf->__VtrigSched_he0995f9e__0.resume("@(posedge thiele_cpu_kami_tb.clk)");
    }
    if ((2ULL & vlSelf->__VactTriggered.word(0U))) {
        vlSelf->__VtrigSched_he099605b__0.resume("@(negedge thiele_cpu_kami_tb.clk)");
    }
...
void Vthiele_cpu_kami_tb___024root___timing_commit(Vthiele_cpu_kami_tb___024root* vlSelf) {
    ...
    // Body
    if ((! (1ULL & vlSelf->__VactTriggered.word(0U)))) {
        vlSelf->__VtrigSched_he0995f9e__0.commit("@(posedge thiele_cpu_kami_tb.clk)");
    }
    if ((! (2ULL & vlSelf->__VactTriggered.word(0U)))) {
        vlSelf->__VtrigSched_he099605b__0.commit("@(negedge thiele_cpu_kami_tb.clk)");
    }
}
