...
(** =========================================================================
    NOTE: All Tier 1 theorems are NOW PROVEN

    T1-1: normalized_E_bound — proven above
    T1-2: valid_box_S_le_4 — proven above

    T1-3 (local_box_S_le_2): Classical CHSH bound for local boxes
      - Proven as local_box_CHSH_bound in MinorConstraints.v
      - Also proven as local_S_2_deterministic in BoxCHSH.v
      - Proof: exhaustive case analysis on deterministic ±1 strategies,
        then convex combination argument (Fine's theorem)

    T1-4 (pr_box_no_extension): PR box has no tripartite extension
      - Proven as pr_box_no_extension in TestTripartite.v
      - Proof: normalization counting argument — the marginal sums
        over z give factor 2, but box normalization gives 1
...
(** =========================================================================
    ...
    All theorems closed — no project-local axioms remain.
    ========================================================================= *)
