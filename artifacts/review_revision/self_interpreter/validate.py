"""B3 self-interpreter validation.  Every command runs under a time limit and
...
MODS = ['VMSelfGuest', 'VMSelfProgram', 'VMSelfCorrect', 'VMSelfRun',
        'VMSelfUniversal', 'VMSelfLimitative']
...
commands += [('integration', ['make', 'kernel/foundation/VMSelfLimitative.vo']),
