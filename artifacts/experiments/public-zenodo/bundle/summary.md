# Thiele proofpack summary — public-zenodo

- **Verdict:** PASS
- **Created:** 2025-10-30T04:12:20.635198Z
- **Bundled artefacts:** 85
- **Notes:**
...
- single_particle_03: PASS (verifier=verifier/public_spt_0.json)
  - OOS error = 2.5%
  - blind ΔAIC = 553
  - sighted slope CI ≈ [0.997, 1]
  - destroyed ρ = -0.335
- brownian_beads_02: PASS (verifier=verifier/public_spt_1.json)
  - OOS error = 1.1%
  - blind ΔAIC = 553
  - sighted slope CI ≈ [0.997, 1]
  - destroyed ρ = -0.335
- optical_tweezers_01: PASS (verifier=verifier/public_spt_2.json)
  - OOS error = 0.6%
  - blind ΔAIC = 553
  - sighted slope CI ≈ [0.996, 1]
  - destroyed ρ = -0.335
- convection_cells_01: PASS (verifier=verifier/public_spt_3.json)
  - OOS error = 1.7%
  - blind ΔAIC = 553
  - sighted slope CI ≈ [0.998, 1]
  - destroyed ρ = -0.335
