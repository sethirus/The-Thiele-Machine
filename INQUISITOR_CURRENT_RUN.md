# INQUISITOR REPORT
Generated: 2026-01-02 05:58:36Z (UTC)
Scanned: 233 Coq files across the repo
## Summary
- HIGH: 2
- MEDIUM: 5
- LOW: 4
...
| score | tags | file |
|---:|---|---|
| 295 | prop:=True, ...->True | `coq/shor_primitives/PolylogConjecture.v` |
...
- L70: **IMPLIES_TRUE_STMT** — Statement ends in \`-> True.\` (likely vacuous).
  - `Lemma period_from_known_factors_complexity :`
- L146: **TRUE_CONST** — Definition is constant True.
