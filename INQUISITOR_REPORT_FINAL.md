# INQUISITOR REPORT
Generated: 2025-12-23 14:48:47Z (UTC)
...
- L151: **PHYSICS_ANALOGY_CONTRACT** — Physics-analogy theorem lacks invariance lemma and is not labeled definitional.
  - `Theorem supra_16_5_program_chsh :`
- L173: **PHYSICS_ANALOGY_CONTRACT** — Physics-analogy theorem lacks invariance lemma and is not labeled definitional.
  - `Lemma supra_program_chsh_definitional_invariance :`

#### `coq/bridge/FiniteQuantum_to_Kernel.v`
- L155: **PHYSICS_ANALOGY_CONTRACT** — Physics-analogy theorem lacks invariance lemma and is not labeled definitional.
  - `Theorem tsirelson_envelope_program_chsh :`
- L176: **PHYSICS_ANALOGY_CONTRACT** — Physics-analogy theorem lacks invariance lemma and is not labeled definitional.
  - `Lemma tsirelson_envelope_chsh_invariance :`
- L190: **PHYSICS_ANALOGY_CONTRACT** — Physics-analogy theorem lacks invariance lemma and is not labeled definitional.
  - `Corollary tsirelson_envelope_compiled_chsh :`
- L214: **PHYSICS_ANALOGY_CONTRACT** — Physics-analogy theorem lacks invariance lemma and is not labeled definitional.
...
- L126: **UNUSED_HYPOTHESIS** — Introduced hypothesis \`Hok\` not used in proof body (heuristic).
  - `intros t n Hok.`
- L219: **UNUSED_HYPOTHESIS** — Introduced hypothesis \`p\` not used in proof body (heuristic).
  - `intros p Hp Hok.`
- L219: **UNUSED_HYPOTHESIS** — Introduced hypothesis \`Hok\` not used in proof body (heuristic).
  - `intros p Hp Hok.`
