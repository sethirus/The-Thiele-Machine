...
Key Points
- Verified containment and separation proofs (Coq) demonstrating Turing ⊂ Thiele.
- Empirical demonstrators showing exponential blind/sighted separations on
  Tseitin expanders.
- Bell inequality demonstration and Tsirelson witness verified via SMT and
  replayed in Coq.
- Hardware reference (Verilog) with audit logging and μ-bit accounting.
...
Contact
-------
Devon Thiele — thethielemachine@gmail.com
