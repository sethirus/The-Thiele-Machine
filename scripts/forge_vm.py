...
What this script does:
  1. Reads build/thiele_core.ml and verifies all 51 constructors are present
...
Ground truth: coq/kernel/foundation/VMStep.v (51 opcodes), coq/kernel/foundation/VMState.v
