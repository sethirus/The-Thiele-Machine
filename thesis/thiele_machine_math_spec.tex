...
A zero-cost oracle is logically inconsistent with $\mu$-conservation. Specifically, \texttt{oracle\_halts\_costs\_mu} proves that zero-cost oracles violate soundness, and \texttt{oracle\_cost\_linear} proves the linear lower bound.
\end{theorem}
