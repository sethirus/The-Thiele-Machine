...
\begin{itemize}
    ...
    \item \texttt{CompositionalWeightFamily\_Infinite}, \texttt{KernelNoGo\_UniqueWeight\_Fails}
...
Key theorems include:
\begin{itemize}
    \item \texttt{wave\_energy\_conserved}, \texttt{wave\_momentum\_conserved}, \texttt{wave\_step\_reversible}
