...
Compilation of the formal development serves as the definitive check that every theorem in this index is valid. The full build currently produces 286 \texttt{.vo} targets with zero errors, and the Inquisitor report currently scans 292 Coq files with zero HIGH/MEDIUM/LOW findings.
