...
\section{HardMathFacts Theorems (archived)}

\textbf{Note}: \texttt{HardMathFactsProven.v} and \texttt{AssumptionBundle.v} have been archived to \texttt{archive/kernel\_exploratory/dead\_end\_chains/}.
