...
\begin{tikzpicture}[scale=1.8, 
    node distance=3cm,
    model/.style={rectangle, draw, rounded corners, minimum width=5.5cm, minimum height=2.0cm, align=center, fill=blue!10},
    algo/.style={rectangle, draw, rounded corners, minimum width=5.5cm, minimum height=2.0cm, align=center, fill=green!15},
    bridge/.style={rectangle, draw, rounded corners, minimum width=5.5cm, minimum height=2.0cm, align=center, fill=yellow!20},
...
\begin{tikzpicture}[scale=1.8, 
    node distance=2.5cm,
    stepstyle/.style={rectangle, draw, rounded corners, minimum width=5.5cm, minimum height=2.0cm, align=center, fill=blue!10},
    result/.style={rectangle, draw, rounded corners, minimum width=5.5cm, minimum height=2.0cm, align=center, fill=green!15},
    arrow/.style={->, >=Stealth, thick}
]
    % Input
