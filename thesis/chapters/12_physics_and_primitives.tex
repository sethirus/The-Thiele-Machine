...
\begin{tikzpicture}[scale=1.8, 
    node distance=3cm,
    model/.style={rectangle, draw, rounded corners=3pt, minimum width=5.5cm, minimum height=2.0cm, align=center, fill=blue!10},
    algo/.style={rectangle, draw, rounded corners=3pt, minimum width=5.5cm, minimum height=2.0cm, align=center, fill=green!15},
    bridge/.style={rectangle, draw, rounded corners=3pt, minimum width=5.5cm, minimum height=2.0cm, align=center, fill=yellow!15},
    arrow/.style={->, >=Stealth, thick}
]
    % Physics models
    \node[font=\normalsize\bfseries] at (-3, 2.5) {Physics Models};
    \node[model, align=center, text width=4.5cm] (wave) at (-4, 1.5) {Wave\\Propagation};
    \node[model, align=center, text width=4.5cm] (diss) at (-2, 1.5) {Dissipative\\Systems};
    \node[model, align=center, text width=4.5cm] (discrete) at (-3, 0.5) {Discrete\\Lattices};
    
    % Algorithmic primitives
    \node[font=\normalsize\bfseries] at (3, 2.5) {Algorithmic Primitives};
    \node[algo, align=center, text width=4.5cm] (period) at (2, 1.5) {Period\\Finding};
    \node[algo, align=center, text width=4.5cm] (gcd) at (4, 1.5) {Euclidean\\GCD};
    \node[algo, align=center, text width=4.5cm] (mod) at (3, 0.5) {Modular\\Arithmetic};
    
    % Bridge
    \node[bridge, minimum width=7.2cm, align=center, text width=4.5cm] (bridge) at (0, -1) {\textbf{Bridge Modules}\\Domain $\rightarrow$ Kernel};
...
\begin{tikzpicture}[scale=1.8, 
    node distance=3.0cm,
    cell/.style={rectangle, draw, minimum width=1.4cm, minimum height=2.0cm, align=center}
]
    % Wave state
    ...
    \node[draw, rounded corners=3pt, fill=yellow!15, text width=5cm, align=center, font=
ormalsize] at (2, -1.5) {
    ...
    % Arrow
    \draw[->, >=Stealth, line width=1.2pt] (2, -0.3) -- (2, -0.8);
\end{tikzpicture}
...
\begin{tikzpicture}[scale=1.8, 
    node distance=3.0cm,
    stepstyle/.style={rectangle, draw, rounded corners=3pt, minimum width=5.5cm, minimum height=2.0cm, align=center, fill=blue!10},
    result/.style={rectangle, draw, rounded corners=3pt, minimum width=5.5cm, minimum height=2.0cm, align=center, fill=green!15},
    arrow/.style={->, >=Stealth, thick}
]
    % Input
    \node[stepstyle, align=center, text width=4.5cm] (input) at (0, 2) {$N$ to factor\\$a$ coprime to $N$};
    
    % Period finding
    \node[stepstyle, align=center, text width=4.5cm] (period) at (0, 0.5) {Find period $r$\\$a^r \equiv 1 \pmod{N}$};
    
    % Candidate
    \node[stepstyle, align=center, text width=4.5cm] (candidate) at (0, -1) {Compute $g$\\$g = \gcd(a^{r/2} - 1, N)$};
...
ormalsize, text width=4cm, align=left, align=center] at (5, 0) {
    ...
    % Theorem
    \node[draw, rounded corners=3pt, fill=yellow!15, font=
...
\begin{tikzpicture}[scale=1.8, 
    ...
    % Results
    \node[result, align=center, text width=4.5cm] (physics) at (-3, 1.5) {Physics Models\\Conservation Laws};
    \node[result, align=center, text width=4.5cm] (shor) at (3, 1.5) {Shor Primitives\\Verified};
    \node[result, align=center, text width=4.5cm] (bridge) at (-3, -1.5) {Bridge Modules\\6 files};
    \node[result, align=center, text width=4.5cm] (toe) at (3, -1.5) {TOE Limits\\No unique physics};
    
    % Central
    \node[central, align=center, text width=4.5cm] (central) at (0, 0) {\textbf{Theory $\leftrightarrow$ Algorithms}\\Infrastructure};
