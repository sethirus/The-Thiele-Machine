...
The derivation of Planck's constant $h$ from Landauer's principle represents the clearest success. The formal proof is in \path{coq/physics_exploration/PlanckDerivation.v} (58 lines, compiles).
