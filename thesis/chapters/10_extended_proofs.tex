...
The quantum axiom proofs live in five files totaling 1,191 lines of Coq with zero \texttt{Admitted} statements:
...
\midrule
\texttt{NoCloning.v} & 243 & 18 & No-cloning from conservation \\
...
\begin{enumerate}
    ...
    \item \textbf{Quantum axioms from $\mu$-accounting}: No-cloning, unitarity, Born rule, purification, and Tsirelson bound all derived from conservation of structural information (1,191 lines, 74 theorems).
