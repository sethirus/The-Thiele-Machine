...
\begin{tikzpicture}[scale=1.8, 
    node distance=3cm,
    domainstyle/.style={rectangle, draw, rounded corners, minimum width=5.0cm, minimum height=2.0cm, align=center, fill=blue!10},
    core/.style={rectangle, draw, rounded corners, minimum width=6.2cm, minimum height=2.1cm, align=center, fill=yellow!20},
...
\begin{tikzpicture}[
    ...
    % Kernel
    \node[rectangle, draw, rounded corners, fill=yellow!20, minimum width=7.2cm, minimum height=2.1cm, align=center, text width=4.5cm] (kernel) at (0, 0) {\textbf{Kernel Semantics}\\Compositionality};
...
\begin{tikzpicture}[scale=1.8, 
    node distance=2.5cm,
    result/.style={rectangle, draw, rounded corners, minimum width=6.2cm, minimum height=2.0cm, align=center, fill=green!15},
