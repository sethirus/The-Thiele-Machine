...
The quantum axiom proofs live in five files totaling 1,192 lines of Coq with zero \texttt{Admitted} statements:
...
\begin{enumerate}
    ...
    \item \textbf{Quantum axioms from $\mu$-accounting}: No-cloning, unitarity, Born rule, purification, and Tsirelson bound all derived from conservation of structural information (1,192 lines, 74 theorems).
