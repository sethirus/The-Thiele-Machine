...
\begin{tikzpicture}[scale=1.8, 
    node distance=3cm,
    domainstyle/.style={rectangle, draw, rounded corners=3pt, minimum width=5.0cm, minimum height=2.0cm, align=center, fill=blue!10},
    core/.style={rectangle, draw, rounded corners=3pt, minimum width=6.2cm, minimum height=2.1cm, align=center, fill=yellow!15},
    arrow/.style={->, >=Stealth, thick}
]
    % Core
    \node[core, align=center, text width=4.5cm] (kernel) at (0, 0) {\textbf{Kernel Semantics}\\VMState, VMStep, $\mu$};
    
    % Domains
    \node[domainstyle, align=center, text width=4.5cm] (partition) at (-4, 2) {Partition\\Logic};
    \node[domainstyle, align=center, text width=4.5cm] (quantum) at (-1.5, 2.5) {Quantum\\Bounds};
    \node[domainstyle, align=center, text width=4.5cm] (toe) at (1.5, 2.5) {TOE\\Limits};
    \node[domainstyle, align=center, text width=4.5cm] (physics) at (4, 2) {Physics\\Models};
    
    \node[domainstyle, align=center, text width=4.5cm] (bridge) at (-4, -2) {Bridge\\Lemmas};
    \node[domainstyle, align=center, text width=4.5cm] (nofi) at (-1.5, -2.5) {NoFI\\Interface};
    \node[domainstyle, align=center, text width=4.5cm] (self) at (1.5, -2.5) {Self-\\Reference};
    \node[domainstyle, align=center, text width=4.5cm] (modular) at (4, -2) {Modular\\Proofs};
...
\begin{tikzpicture}[
    node distance=3.0cm,
    forces/.style={rectangle, draw, rounded corners=3pt, minimum width=4.9cm, minimum height=1.2cm, align=center, fill=green!15, font=
ormalsize},
    nogo/.style={rectangle, draw, rounded corners=3pt, minimum width=4.9cm, minimum height=1.2cm, align=center, fill=red!15, font=
ormalsize},
    arrow/.style={->, >=Stealth, thick},
    scale=1.05
]
    % Kernel
    \node[rectangle, draw, rounded corners=3pt, fill=yellow!15, minimum width=7.2cm, minimum height=2.1cm, align=center, text width=4.5cm] (kernel) at (0, 0) {\textbf{Kernel Semantics}\\Compositionality};
...
, node distance=3.0cm]
    ...
    \foreach \x in {0, 2.5, 5, 7.07, 10} {
        \draw[line width=1.2pt] (\x, -0.2) -- (\x, 0.2);
    }
    ...
    \draw[line width=1.2pt, red, ->] (7.07, 2) -- (7.07, 0.3);
    \node[above, font=
...
\begin{tikzpicture}[scale=1.8, 
    node distance=3.0cm,
    result/.style={rectangle, draw, rounded corners=3pt, minimum width=6.2cm, minimum height=2.0cm, align=center, fill=green!15},
    central/.style={rectangle, draw, rounded corners=3pt, minimum width=7.2cm, minimum height=2.1cm, align=center, fill=yellow!15},
    arrow/.style={->, >=Stealth, thick}
]
    % Results
    \node[result, align=center, text width=4.5cm] (corpus) at (-3, 1.5) {Zero-Admit\\Corpus};
    ...
    % Central
    \node[central, align=center, text width=4.5cm] (central) at (0, 0) {\textbf{Machine-Verified}\\Computational Physics};
