...
\begin{tikzpicture}[scale=1.8, 
    ...
    box/.style={rectangle, draw, rounded corners, minimum width=5.5cm, minimum height=2.1cm, align=center, fill=blue!10},
    topic/.style={rectangle, draw, rounded corners, minimum width=4.5cm, minimum height=2.0cm, align=center, fill=green!10},
    arrow/.style={->, very thick, >=stealth}
]
% Central question
\node[box, fill=red!20, minimum width=7.2cm, align=center, text width=4.5cm, font=\normalsize] (meaning) {From Proofs\\to Meaning};
...
\begin{tikzpicture}[scale=1.8, 
    ...
    phys/.style={rectangle, draw, rounded corners, minimum width=5.5cm, minimum height=2.0cm, align=center, fill=blue!20},
    comp/.style={rectangle, draw, rounded corners, minimum width=5.5cm, minimum height=2.0cm, align=center, fill=green!20},
...
\begin{tikzpicture}[scale=1.8, 
    ...
    layer/.style={rectangle, draw, rounded corners, minimum width=5.4cm, minimum height=2.1cm, align=center},
    arrow/.style={->, very thick, >=stealth}
]
% Three layers
\node[layer, fill=blue!20, align=center, text width=4.5cm] (abstract) {Abstract\\$\mu$-ledger charges $n$ bits};
\node[layer, fill=yellow!20, below=2.0cm of abstract, align=center, text width=4.5cm] (bridge) {Bridge Postulate\\$Q_{\min} = k_B T \ln 2 \cdot \mu$};
\node[layer, fill=green!20, below=2.0cm of bridge, align=center, text width=4.5cm] (physical) {Physical\\$Q \ge k_B T \ln 2 \cdot n$};
...
% Two strategies
\node[box, fill=red!20, align=center, text width=4.5cm, font=\normalsize] (blind) {Blind Search\\$T = O(2^n)$\\$\mu = O(1)$};
\node[box, fill=green!20, right=5.9cm of blind, align=center, text width=4.5cm, font=\normalsize] (sighted) {Sighted Search\\$T = O(k \cdot 2^{n/k})$\\$\mu = O(k)$};
\draw[arrow] (blind) -- (sighted) node[midway, above, font=\small] {Trade-off};

% Total cost annotation
\node[draw, rounded corners, fill=yellow!20, minimum width=9.0cm, font=\small, yshift=-6pt] at (2.9,-2) {$\text{Total Cost} = T(x) + \mu(x)$};
...
\begin{tikzpicture}[scale=1.8, 
    ...
    box/.style={rectangle, draw, rounded corners, minimum width=5.5cm, minimum height=2.1cm, align=center},
    arrow/.style={->, very thick, >=stealth}
]
% LLM path (top)
...
% Thiele path (bottom)
\node[box, fill=blue!20, below=2.9cm of llm, align=center, text width=4.5cm, font=\normalsize] (predict) {Model\\Predicts};
\node[box, fill=yellow!20, right=2.9cm of predict, align=center, text width=4.5cm, font=\normalsize] (certify) {VM\\Certifies};
\node[box, fill=green!20, right=2.9cm of certify, align=center, text width=4.5cm, font=\normalsize] (output2) {Output\\(verified)};
...
\begin{tikzpicture}[scale=1.8, 
    ...
    receipt/.style={rectangle, draw, rounded corners, minimum width=4.5cm, minimum height=2.6cm, align=center, fill=blue!10},
    arrow/.style={->, very thick, >=stealth}
]
% Receipt chain
...
% Receipt structure
\node[below=2.9cm of $(r2)!0.5!(r3)$, draw, rounded corners, fill=yellow!20, minimum width=10.8cm, minimum height=3.6cm, align=left, font=\ttfamily\scriptsize, align=center, text width=4.5cm] (struct) {
receipt = \{\\
...
\begin{tikzpicture}[scale=1.8, 
    node distance=2.5cm and 1.5cm,
    current/.style={rectangle, draw, rounded corners, minimum width=5.4cm, minimum height=2.1cm, align=center, fill=green!20},
    future/.style={rectangle, draw, rounded corners, minimum width=5.4cm, minimum height=2.1cm, align=center, fill=blue!10},
    arrow/.style={->, very thick, >=stealth, dashed}
]
% Current state
...
% Key insight
\node[below=1.0cm of result, draw, rounded corners, fill=yellow!20, minimum width=14.4cm,  font=\small, yshift=-6pt] {$\mu$-accounting unifies computation, physics, and verification};
\end{tikzpicture}
