...
\node[box, fill=green!20, right=5.9cm of blind, align=center, text width=3.5cm,  font=\bfseries, font=\small, yshift=6pt] {Difficulty Conservation};
\draw[arrow] (blind) -- node[above, yshift=6pt, font=\normalsize, pos=0.5,  draw, rounded corners, fill=yellow!20, minimum width=9.0cm, font=\small, yshift=-6pt] {$\text{Total Cost} = T(x) + \mu(x)$};

% Annotations
\node[below=0.4cm of blind,  red, font=\small, yshift=-6pt] {High time, low structure};
\node[below=0.4cm of sighted,  green!50!black, font=\small, yshift=-6pt] {Low time, high structure};
\end{tikzpicture}
...
\node[box, right=3.9cm of llm, fill=red!10, align=center, text width=3.5cm,  yshift=6pt, font=\normalsize, font=\small] {hallucination\\risk} (output1);
