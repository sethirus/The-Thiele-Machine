...
\begin{tikzpicture}[scale=1.8, 
    ...
    % Central node
    \node[block, fill=red!20, minimum width=7.2cm, align=center, text width=4.5cm] (zero) at (0,0) {\textbf{Zero-Admit Standard}\\No Admitted, No admit., No Axiom};
...
\centering
\begin{tikzpicture}[scale=1.8, 
    stage/.style={rectangle, draw, fill=blue!20, minimum width=5.5cm, minimum height=2.1cm, align=center, rounded corners},
    check/.style={rectangle, draw, fill=green!20, minimum width=4.5cm, minimum height=2.0cm, align=center, font=\footnotesize},
    arrow/.style={->, >=stealth, thick}
, node distance=2.5cm]
    % Pipeline stages
...
\centering
\begin{tikzpicture}[scale=1.8, 
    module/.style={rectangle, draw, fill=blue!20, minimum width=4.2cm, minimum height=2.2cm, align=center},
...
, node distance=2.5cm]
    ...
    \node[set, fill=green!20, minimum width=5.5cm, minimum height=2.5cm] (strong) at (3, 0) {};
...
, node distance=2.5cm]
    ...
    \node[draw, fill=red!30, minimum width=9.0cm, minimum height=2.1cm, rounded corners, align=center, text width=4.5cm] (zero) at (0, 0) {\textbf{Zero-Admit Standard}\\206 Proofs, 0 Axioms};
    ...
    % Bottom: Inquisitor
    \node[draw, fill=purple!20, minimum width=14.4cm, minimum height=2.0cm, rounded corners] at (0, -4.5) {\textbf{Inquisitor} enforces standard via CI (25+ rule categories)};
