...
\textbf{Total: 1,191 lines of Coq with zero Admitted statements.} These proofs establish that quantum mechanics isn't a collection of independent postulates---it's the unique physics consistent with information conservation.
...
\hline
NoCloning.v & 243 & \texttt{no\_cloning\_from\_conservation} & \checkmark\ Zero Admitted \\
...
\begin{enumerate}
    ...
    \item \textbf{Quantum Axioms}: No-cloning, unitarity, Born rule, purification, and Tsirelson bounds emerge from $\mu$-conservation (1,191 lines, zero Admitted)
