...
\hline
NoCloning.v & 244 & \texttt{no\_cloning\_from\_conservation} & ✓ Zero Admitted \\
Unitarity.v & 257 & \texttt{nonunitary\_requires\_mu} & ✓ Zero Admitted \\
BornRule.v & 288 & \texttt{born\_rule\_from\_accounting} & ✓ Zero Admitted \\
Purification.v & 102 & \texttt{purification\_principle} & ✓ Zero Admitted \\
TsirelsonGeneral.v & 301 & \texttt{tsirelson\_from\_minors} & ✓ Zero Admitted \\
\end{tabular}
\end{tcolorbox}
