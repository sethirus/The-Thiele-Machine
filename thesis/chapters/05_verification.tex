...
\begin{tikzpicture}[scale=1.8, 
    node distance=2.5cm,
    block/.style={rectangle, draw, fill=blue!10, minimum width=5.4cm, minimum height=1.4cm, align=center},
...
\begin{tikzpicture}[scale=1.8, 
    ...
    check/.style={rectangle, draw, fill=green!20, minimum width=3.6cm, minimum height=1.1cm, align=center, font=\footnotesize},
    arrow/.style={->, >=stealth, thick}
, node distance=2.5cm]
    % Pipeline stages
...
\centering
\begin{tikzpicture}[scale=1.8, 
    module/.style={rectangle, draw, fill=blue!20, minimum width=3.2cm, minimum height=2.2cm, align=center},
...
, node distance=3cm]
    ...
    \draw[->, >=stealth, very very thick, red, shorten >=2pt, shorten <=2pt] (-0.8, 0.5) -- (0.8, 0.5);
...
, node distance=3cm]
    ...
    % Arrow with shift
    \draw[->, >=stealth, very very thick, blue, shorten >=2pt, shorten <=2pt] (-1.5, 0) -- (1.5, 0);
...
, node distance=3cm]
    ...
    \draw[arrow] (s0) -- node[above, yshift=6pt, sloped, pos=0.5,  yshift=6pt, font=\small] {\footnotesize $+\mu_2$} (s2);
    \draw[arrow] (s2) -- node[above, yshift=6pt, font=\small] {\footnotesize $+\mu_3$} (s3);
    ...
    % Monotonicity arrow
    \draw[->, >=stealth, very very thick, red, dashed, shorten >=2pt, shorten <=2pt] (0, -1.8) -- (11, -1.8);
...
, node distance=2.5cm]
    ...
    \draw[->, >=stealth, very very thick, red, shorten >=2pt, shorten <=2pt] (-0.8, 0) -- (0.8, 0);
...
\begin{tikzpicture}[scale=1.8, 
    ...
    property/.style={rectangle, draw, fill=blue!10, minimum width=6.2cm, minimum height=1.4cm, align=center},
    arrow/.style={->, >=stealth, thick}
, node distance=2.5cm]
    ...
    % Bottom: Inquisitor
    \node[draw, fill=purple!20, minimum width=14.4cm, minimum height=1.4cm, rounded corners] at (0, -4.5) {\textbf{Inquisitor} enforces standard via CI (25+ rule categories)};
