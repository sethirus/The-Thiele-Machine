...
\textbf{Why this matters:} The result is trivial in isolation, but it formalizes an important design property: the absolute $\mu$ value carries no physical meaning. Only $\mu$ \textit{differences} matter for the partition structure. This is the sense in which I call it ``gauge invariance''---the zero point of $\mu$ is arbitrary, analogous to the arbitrary zero of potential energy in physics.
