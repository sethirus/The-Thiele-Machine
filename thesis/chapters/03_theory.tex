...
\begin{itemize}
    ...
    \item \textbf{flen}: The encoded formula-unit count. This is the primary cost driver: $\Delta\mu = \mathtt{flen} \times 8 + S(\mathtt{cost})$, ensuring longer formulas cost proportionally more in bits.
\end{itemize}
