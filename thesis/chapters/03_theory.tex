...
\begin{itemize}
    ...
    \item \path{coq/kernel/Unitarity.v}: 570 lines, 23 definitions/theorems
    \item \path{coq/kernel/BornRule.v}: 311 lines, 20 definitions/theorems
    \item \path{coq/kernel/Purification.v}: 275 lines, 11 definitions/theorems
    \item \path{coq/kernel/TsirelsonGeneral.v}: 301 lines, 19 definitions/theorems
\end{itemize}
Total: 2,393 lines of machine-verified proofs establishing that quantum axioms emerge from $\mu$-conservation.
\end{tcolorbox}
