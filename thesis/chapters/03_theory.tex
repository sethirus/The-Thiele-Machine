...
\begin{itemize}
    \item \path{coq/kernel/NoCloning.v}: 936 lines, 18 definitions/theorems
    \item \path{coq/kernel/NoCloningFromMuMonotonicity.v}: 260 lines, 11 definitions/theorems (machine-native, \texttt{lia}-only)
    \item \path{coq/kernel/Unitarity.v}: 583 lines, 24 definitions/theorems
    \item \path{coq/kernel/BornRule.v}: 321 lines, 20 definitions/theorems
    \item \path{coq/kernel/BornRuleFromSymmetry.v}: 939 lines, 33 definitions/theorems (non-circular, tensor consistency)
    \item \path{coq/kernel/Purification.v}: 280 lines, 11 definitions/theorems
    \item \path{coq/kernel/TsirelsonGeneral.v}: 315 lines, 19 definitions/theorems
    \item \path{coq/kernel/TsirelsonFromAlgebra.v}: 327 lines, 13 definitions/theorems (self-contained algebraic)
\end{itemize}
Total: 3,961 lines of machine-verified proofs across eight files establishing that quantum axioms emerge from $\mu$-conservation.
\end{tcolorbox}
