...
\centering
\begin{tikzpicture}[
    box/.style={draw, rounded corners, minimum width=5.5cm, minimum height=2.0cm, align=center, font=\normalsize},
...
\centering
\begin{tikzpicture}[
    module/.style={draw, rounded corners, minimum width=5.0cm, minimum height=2.4cm, align=center, font=\normalsize},
...
% Module M1
\node[module, fill=blue!20, align=center, text width=4.5cm, font=\normalsize] (M1) at (-2.5, 0) {Module $M_1$\\ID: 0};
...
% Module M2
\node[module, fill=green!20, align=center, text width=4.5cm, font=\normalsize] (M2) at (1, 0) {Module $M_2$\\ID: 1};
...
\node[cat, fill=yellow!20, align=center, text width=4.5cm] (meas) at (4, -1) {
...
\centering
\begin{tikzpicture}[
    module/.style={draw, rounded corners, minimum width=4.2cm, minimum height=2.0cm, align=center, font=\normalsize},
    arrow/.style={->, >=stealth, thick},
    scale=1.05
, node distance=3cm]
% PNEW
...
\node[module, fill=green!20, minimum width=2.4cm, align=center, text width=4.5cm, font=\normalsize] (psplit_left) at (-1, -0.5) {$M_L$\\$\{0,1\}$};
...
\node[box, fill=red!20, minimum width=8.2cm, minimum height=5.0cm, align=center, text width=4.5cm, font=\normalsize] (omega) at (-5, 0) {
    \textbf{Search Space $\Omega$}\\[0.3cm]
    \large $2^n$ possibilities
};

% After: Reduced search space
\node[box, fill=green!20, minimum width=5.0cm, minimum height=3.2cm, align=center, text width=4.5cm, font=\normalsize] (omega_prime) at (5, 0) {
...
\centering
\begin{tikzpicture}[
    concept/.style={draw, rounded corners, minimum width=5.0cm, minimum height=2.4cm, align=center, font=\normalsize},
    result/.style={draw, very thick, fill=yellow!20, rounded corners, minimum width=6.2cm, minimum height=2.0cm, align=center, font=\normalsize},
    scale=1.05
, node distance=2.5cm]
% Core concepts
\node[concept, fill=blue!20, align=center, text width=4.5cm] (state) at (-4, 3) {State Space\\$S$};
\node[concept, fill=green!20, align=center, text width=4.5cm] (partition) at (-1.5, 3) {Partition Graph\\$\Pi$};
\node[concept, fill=orange!20, align=center, text width=4.5cm] (mu) at (1.5, 3) {$\mu$-Ledger\\Currency};
\node[concept, fill=red!20, align=center, text width=4.5cm] (rules) at (4, 3) {Transition\\Rules $R$};
...
% Master result
\node[draw, ultra thick, fill=green!30, rounded corners, minimum width=14.4cm, minimum height=2.6cm, align=center, text width=4.5cm] (master) at (0, -2) {
