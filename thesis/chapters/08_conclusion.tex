...
\begin{tikzpicture}[scale=1.8, 
    node distance=2.5cm,
    box/.style={draw, rounded corners, minimum width=5.4cm, minimum height=1.4cm, align=center, fill=blue!10},
    arrow/.style={->, very thick, >=stealth}
]
...
\begin{tikzpicture}[scale=1.8, 
    node distance=2.5cm,
    box/.style={draw, rounded corners, minimum width=5.0cm, minimum height=1.4cm, align=center, fill=blue!10},
    arrow/.style={->, very thick, >=stealth}
]
    ...
    % Inquisitor
    \node[draw, dashed, fill=yellow!10, minimum width=14.4cm, minimum height=1.4cm, align=center, text width=3.5cm] at (0,-4) {\textbf{Inquisitor}: Enforces zero-admit discipline on all 206 proofs};
...
\begin{tikzpicture}[scale=1.8, 
    node distance=2.5cm,
    box/.style={draw, rounded corners, minimum width=4.6cm, minimum height=1.4cm, align=center, fill=blue!10},
    arrow/.style={->, very thick, >=stealth}
]
    % Current foundation
...
\begin{tikzpicture}[scale=1.8, 
    node distance=2cm,
    box/.style={draw, rounded corners, minimum width=4.6cm, minimum height=1.4cm, align=center}
]
    ...
    % Arrow
    \draw[->, ultra very thick, blue] (turing) -- node[above, yshift=6pt, font=\small] {$+\mu$-accounting} (thiele);
