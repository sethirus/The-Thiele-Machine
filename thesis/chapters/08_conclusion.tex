...
\begin{tikzpicture}[scale=1.8, 
    node distance=3cm,
    box/.style={draw, rounded corners=3pt, minimum width=5.5cm, minimum height=2.1cm, align=center, fill=blue!10, inner sep=0.4cm},
    arrow/.style={->, line width=1.2pt, >=Stealth}
]
    % Central question
    \node[box, fill=yellow!15, minimum width=7.2cm, align=center, text width=4.5cm, font=
ormalsize] (q) at (0,0) {\textbf{Central Question}\\What I Set Out to Do};
    
    % Three goals
    \node[box, fill=green!15, align=center, text width=4.5cm, font=
...
ormalsize] (v) at (4,-2) {\textbf{Verification}\\Zero-Admit};
    ...
    \node[box, fill=orange!20, minimum width=7.2cm, align=center, text width=4.5cm, font=
ormalsize] (h) at (0,-4) {\textbf{Hypothesis Confirmed}\\No Free Insight};
    
    % Applications and Future
    \node[box, fill=purple!15, align=center, text width=4.5cm, font=
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{Verification (right):} Zero-admit standard (206 proofs, 0 admits, 0 axioms, Inquisitor enforcement).
    \end{itemize}
...
\begin{tikzpicture}[scale=1.8, 
    node distance=3.0cm,
    box/.style={draw, rounded corners=3pt, minimum width=5.4cm, minimum height=2.0cm, align=center, fill=blue!10, inner sep=0.4cm},
    arrow/.style={->, line width=1.2pt, >=Stealth}
]
    % Four main contributions
    \node[box, fill=yellow!15, align=center, text width=4.5cm, font=
ormalsize] (tuple) at (0,0) {\textbf{5-Tuple Formalization}\\$T = (S, \Pi, A, R, L)$};
    \node[box, fill=green!15, align=center, text width=4.5cm, font=
ormalsize] (mu) at (5,0) {\textbf{$\mu$-bit Currency}\\Monotone Ledger};
    \node[box, fill=orange!15, align=center, text width=4.5cm, font=
...
ormalsize] (nosig) at (5,-2.5) {\textbf{No-Signaling}\\Bell Locality};
    ...
    % Central node
    \node[draw, circle, fill=red!12, minimum size=1.5cm, align=center, text width=4.5cm] (center) at (2.5,-1.25) {\textbf{Coq}\\Verified};
    ...
    % File annotations
    \node[ gray, below=0.3cm of tuple, font=\small, yshift=-6pt] {VMState.v, VMStep.v};
    \node[ gray, below=0.3cm of mu, font=\small, yshift=-6pt] {MuLedgerConservation.v};
    \node[ gray, below=0.3cm of nfi, above, font=\small, yshift=6pt] {NoFreeInsight.v};
    \node[ gray, below=0.3cm of nosig, above, font=\small, yshift=6pt] {KernelPhysics.v};
\end{tikzpicture}
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item No hidden assumptions (zero axioms beyond foundational logic).
...
\begin{tikzpicture}[scale=1.8, 
    node distance=3.0cm,
    layer/.style={draw, rounded corners=3pt, minimum width=9.0cm, minimum height=2.2cm, align=center},
    arrow/.style={<->, line width=1.2pt, >=Stealth}
]
    % Three layers
    \node[layer, fill=blue!15, align=center, text width=4.5cm] (coq) at (0,2) {\textbf{Coq Formal Kernel}\\Zero admits, zero axioms\\{\scriptsize coq/kernel/}};
    \node[layer, fill=green!15, align=center, text width=4.5cm] (py) at (0,0) {\textbf{Python Reference VM}\\Receipts, trace replay\\{\scriptsize thielecpu/}};
    \node[layer, fill=orange!15, align=center, text width=4.5cm] (rtl) at (0,-2) {\textbf{Verilog RTL}\\Synthesis-ready\\{\scriptsize thielecpu/hardware/}};
    
    % Isomorphism arrows
    \draw[arrow, red!60] (coq) -- node[right,  above, yshift=6pt, pos=0.5, font=\small] {Isomorphism} (py);
    \draw[arrow, red!60] (py) -- node[right,  above, yshift=6pt, pos=0.5, font=\small] {Isomorphism} (rtl);
    
    % Invariant box
    \node[draw, dashed, fill=yellow!10, minimum width=10.8cm, align=center, text width=4.5cm] at (0,-4) {
    ...
    % Left annotations
    \node[font=
ormalsize, align=right, align=center, text width=4.5cm] at (-4,2) {Proven\\properties};
    \node[font=
ormalsize, align=right, align=center, text width=4.5cm] at (-4,0) {Executable\\reference};
    \node[font=
ormalsize, align=right, align=center, text width=4.5cm] at (-4,-2) {Hardware\\synthesis};
\end{tikzpicture}
...
\begin{tikzpicture}[scale=1.8, 
    node distance=3.0cm,
    box/.style={draw, rounded corners=3pt, minimum width=5.0cm, minimum height=2.0cm, align=center, fill=blue!10, inner sep=0.4cm},
    arrow/.style={->, line width=1.2pt, >=Stealth}
]
    % Zero-admit standard at center
    \node[draw, circle, fill=red!12, minimum size=2cm, align=center, text width=4.5cm] (zero) at (0,0) {\textbf{Zero-Admit}\\Standard};
...
ormalsize] (gauge) at (3,-2) {Gauge Invariance\\Noether};
    ...
    % Inquisitor
    \node[draw, dashed, fill=yellow!10, minimum width=14.4cm, minimum height=2.0cm, align=center, text width=4.5cm] at (0,-4) {\textbf{Inquisitor}: Enforces zero-admit discipline on all 206 proofs};
...
\begin{tikzpicture}[scale=1.8, 
    node distance=3.0cm,
    box/.style={draw, rounded corners=3pt, minimum width=6.2cm, minimum height=2.1cm, align=center, inner sep=0.4cm},
    arrow/.style={->, line width=1.2pt, >=Stealth}
]
    % Hypothesis at top
    \node[draw, fill=yellow!15, minimum width=10.8cm, minimum height=2.1cm, align=center, text width=4.5cm] (hyp) at (0,2) {\textbf{Hypothesis}: There is no free insight.\\Structure must be paid for.};
...
ormalsize] (validated) at (4,0) {\textbf{VALIDATED}\\CHSH Tests\\Pass};
    ...
    % Result
    \node[draw, fill=green!30, minimum width=10.8cm, minimum height=2.1cm, align=center, text width=4.5cm] (result) at (0,-2) {\textbf{HYPOTHESIS CONFIRMED}\\within the model};
...
\begin{tikzpicture}[scale=1.8, 
    node distance=3.0cm,
    box/.style={draw, rounded corners=3pt, minimum width=5.4cm, minimum height=1.2cm, align=center, inner sep=0.4cm}
]
    % Three isomorphisms
...
ormalsize] (second) at (3,1.5) {Second Law};
    \draw[<->, line width=1.2pt, red] (mu) -- node[above, yshift=6pt, font=
...
ormalsize] (bell) at (3,0) {Bell locality};
    \draw[<->, line width=1.2pt, red] (nosig) -- node[above, yshift=6pt, font=
...
ormalsize] (noether) at (3,-1.5) {Noether's theorem};
    \draw[<->, line width=1.2pt, red] (gauge) -- node[above, yshift=6pt, font=
...
\begin{tikzpicture}[scale=1.8, 
    node distance=3.0cm,
    box/.style={draw, rounded corners=3pt, minimum width=5.5cm, minimum height=2.0cm, align=center, fill=blue!10, inner sep=0.4cm},
    arrow/.style={->, line width=1.2pt, >=Stealth}
]
    % Current foundation
    \node[draw, fill=green!12, minimum width=7.2cm, minimum height=2.1cm, align=center, text width=4.5cm] (now) at (0,0) {\textbf{Foundation Built}\\206 proofs, 3 layers};
...
\begin{tikzpicture}[scale=1.8, 
    node distance=2.5cm,
    box/.style={draw, rounded corners=3pt, minimum width=5.5cm, minimum height=2.0cm, align=center, inner sep=0.4cm}
]
    % Turing vs Thiele comparison
    \node[box, fill=gray!12, align=center, text width=4.5cm, font=
ormalsize] (turing) at (-3,0) {\textbf{Turing Machine}\\Universality};
    \node[box, fill=green!12, align=center, text width=4.5cm, font=
ormalsize] (thiele) at (3,0) {\textbf{Thiele Machine}\\Accountability};
    
    % Arrow
    \draw[->, line width=1.5pt, blue] (turing) -- node[above, yshift=6pt, font=\small] {$+\mu$-accounting} (thiele);
    
    % Properties
    \node[font=
ormalsize, align=center, text width=4.5cm] at (-3,-1.5) {Structure invisible\\Hidden variable\\Success/fail unknown};
    \node[font=
ormalsize, align=center, text width=4.5cm] at (3,-1.5) {Structure explicit\\Paid resource\\Verifiable};
    
    % Central insight
    \node[draw, dashed, fill=yellow!10, minimum width=14.4cm, align=center, text width=4.5cm] at (0,-3) {
