...
\begin{tikzpicture}[scale=1.8, 
    node distance=3cm,
    box/.style={draw, rounded corners, minimum width=5.5cm, minimum height=2.1cm, align=center, fill=blue!10},
    arrow/.style={->, very thick, >=stealth}
]
    % Central question
    \node[box, fill=yellow!20, minimum width=7.2cm, align=center, text width=4.5cm, font=\normalsize] (q) at (0,0) {\textbf{Central Question}\\What I Set Out to Do};
...
\begin{tikzpicture}[scale=1.8, 
    node distance=2.5cm,
    box/.style={draw, rounded corners, minimum width=5.4cm, minimum height=2.0cm, align=center, fill=blue!10},
    arrow/.style={->, very thick, >=stealth}
]
    % Four main contributions
    \node[box, fill=yellow!20, align=center, text width=4.5cm, font=\normalsize] (tuple) at (0,0) {\textbf{5-Tuple Formalization}\\$T = (S, \Pi, A, R, L)$};
    ...
    % Central node
    \node[draw, circle, fill=red!20, minimum size=1.5cm, align=center, text width=4.5cm] (center) at (2.5,-1.25) {\textbf{Coq}\\Verified};
...
\begin{tikzpicture}[scale=1.8, 
    node distance=2.5cm,
    box/.style={draw, rounded corners, minimum width=5.0cm, minimum height=2.0cm, align=center, fill=blue!10},
    arrow/.style={->, very thick, >=stealth}
]
    % Zero-admit standard at center
    \node[draw, circle, fill=red!20, minimum size=2cm, align=center, text width=4.5cm] (zero) at (0,0) {\textbf{Zero-Admit}\\Standard};
...
\begin{tikzpicture}[scale=1.8, 
    node distance=2.5cm,
    box/.style={draw, rounded corners, minimum width=6.2cm, minimum height=2.1cm, align=center},
    arrow/.style={->, very thick, >=stealth}
]
    % Hypothesis at top
    \node[draw, fill=yellow!20, minimum width=10.8cm, minimum height=2.1cm, align=center, text width=4.5cm] (hyp) at (0,2) {\textbf{Hypothesis}: There is no free insight.\\Structure must be paid for.};
    
    % Three confirmations
    \node[box, fill=green!20, align=center, text width=4.5cm, font=\normalsize] (proven) at (-4,0) {\textbf{PROVEN}\\No Free Insight\\Theorem};
    \node[box, fill=blue!20, align=center, text width=4.5cm, font=\normalsize] (verified) at (0,0) {\textbf{VERIFIED}\\3-Layer\\Isomorphism};
...
\begin{tikzpicture}[scale=1.8, 
    node distance=2.5cm,
    box/.style={draw, rounded corners, minimum width=5.5cm, minimum height=2.0cm, align=center, fill=blue!10},
    arrow/.style={->, very thick, >=stealth}
]
    % Current foundation
    \node[draw, fill=green!20, minimum width=7.2cm, minimum height=2.1cm, align=center, text width=4.5cm] (now) at (0,0) {\textbf{Foundation Built}\\206 proofs, 3 layers};
...
\begin{tikzpicture}[scale=1.8, 
    node distance=2cm,
    box/.style={draw, rounded corners, minimum width=5.5cm, minimum height=2.0cm, align=center}
]
    % Turing vs Thiele comparison
    \node[box, fill=gray!20, align=center, text width=4.5cm, font=\normalsize] (turing) at (-3,0) {\textbf{Turing Machine}\\Universality};
    \node[box, fill=green!20, align=center, text width=4.5cm, font=\normalsize] (thiele) at (3,0) {\textbf{Thiele Machine}\\Accountability};
    
    % Arrow
    \draw[->, ultra thick, blue] (turing) -- node[above, yshift=6pt, font=\small] {$+\mu$-accounting} (thiele);
