...
\begin{tikzpicture}[scale=1.8, 
    node distance=3cm,
    box/.style={rectangle, draw=black, line width=0.8pt, rounded corners=3pt, minimum width=5.5cm, minimum height=2.0cm, align=center, fill=blue!10, inner sep=0.4cm},
    cmodule/.style={rectangle, draw, rounded corners=3pt, minimum width=4.5cm, minimum height=2.0cm, align=center, fill=green!15},
...
ormalsize] (verifier) at (0,0) {\textbf{Verifier System}\\Receipt-Defined};
    ...
    % C-modules
    \node[cmodule, align=center, text width=4.5cm, font=
...
ormalsize] (cost) at (4, -1.5) {$\mu$-Cost\\Accounting};
    ...
    % TRS Protocol
    \node[box, fill=red!15, align=center, text width=4.5cm, font=
...
\begin{tikzpicture}[scale=1.8, 
    ...
    % Brace
    \draw[decorate, decoration={brace, amplitude=10pt, mirror}] (3.5, 3.4) -- (3.5, -0.6) node[pos=0.5, font=\small, above, yshift=6pt] {Content-addressed\\Signed\\Minimal};
...
\begin{tikzpicture}[scale=1.8, 
    node distance=3.0cm,
    box/.style={rectangle, draw=black, line width=0.8pt, rounded corners=3pt, minimum width=5.5cm, minimum height=2.0cm, align=center, fill=blue!10, inner sep=0.4cm},
    check/.style={diamond, draw, aspect=2, fill=yellow!15, align=center},
    arrow/.style={->, >=Stealth, thick}
]
    % Flow
    \node[box, align=center, text width=4.5cm, font=
ormalsize] (input) at (0, 0) {Randomness\\Claim};
    ...
    \node[check, align=center, text width=4.5cm] (entropy) at (6, 0) {$H_{min}$\\evidence?};
    \node[box, fill=green!12, font=
ormalsize] (pass) at (9, 0.8) {PASS};
    \node[box, fill=red!12, font=
ormalsize] (fail) at (9, -0.8) {REJECT};
    
    % Arrows
    \draw[arrow] (input) -- (receipt);
    \draw[arrow] (receipt.south) -- ++(0, -0.5) -| node[near start, below, font=\small] {No} (fail);
    \draw[arrow] (entropy) -- node[above, font=\small] {Yes} (pass);
...
\begin{tikzpicture}[scale=1.8, 
    node distance=3cm,
    state/.style={circle, draw, minimum size=0.3cm, fill=blue!12},
    partition/.style={rectangle, draw, dashed, rounded corners=3pt, minimum width=3.5cm, minimum height=2.1cm}
]
...
ormalsize] at (-3, 0) {$|\Omega| = \infty$};
    ...
    % Arrow
    \draw[->, >=Stealth, line width=1.2pt, decorate, decoration={snake, amplitude=2pt, segment length=10pt}] (-1, 1) -- (1, 1) node[pos=0.5, font=\small, above, yshift=6pt] {Coarse-grain};
...
\begin{tikzpicture}[scale=1.8, 
    node distance=3cm,
    var/.style={circle, draw, minimum size=0.8cm, fill=blue!12},
    arrow/.style={->, >=Stealth, thick}
]
    % Equivalence class
...
\begin{tikzpicture}[scale=1.8, 
    node distance=3.0cm,
    cmodule/.style={rectangle, draw, rounded corners=3pt, minimum width=5.4cm, minimum height=2.1cm, align=center, fill=green!15},
    principle/.style={rectangle, draw, rounded corners=3pt, minimum width=9.0cm, minimum height=2.1cm, align=center, fill=yellow!15},
    arrow/.style={->, >=Stealth, thick}
]
    % C-modules
    \node[cmodule, align=center, text width=4.5cm, font=
...
ormalsize] (ccausal) at (3, 0) {C-CAUSAL\\Interventions for DAGs};
    ...
    % Central principle
    \node[principle, align=center, text width=4.5cm] (nfi) at (0, -2) {\textbf{No Free Insight}\\Stronger claims require more evidence};
