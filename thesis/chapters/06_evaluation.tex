...
\begin{itemize}
    ...
    \item \textbf{QM-divergent predictions}: six concrete predictions (QD1--QD6) where the $\mu$-accounting framework diverges from standard quantum mechanics, each with computed numerical thresholds and experimental protocols (Chapter~11).
