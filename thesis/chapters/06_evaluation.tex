...
\begin{tikzpicture}[
    ...
    node distance=2.5cm,
    block/.style={rectangle, draw, fill=blue!10, text width=3.2cm, text centered, minimum height=1.7cm, rounded corners, font=\normalsize},
    testblock/.style={rectangle, draw, fill=green!10, text width=3.2cm, text centered, minimum height=1.7cm, rounded corners, font=\normalsize},
    resultblock/.style={rectangle, draw, fill=orange!10, text width=3.2cm, text centered, minimum height=1.7cm, rounded corners, font=\normalsize}
]
...
\begin{tikzpicture}[
    scale=0.85, transform shape,
    node distance=2.5cm,
    result/.style={rectangle, draw, fill=green!20, text width=3.2cm, text centered, minimum height=1.7cm, rounded corners, font=\normalsize},
