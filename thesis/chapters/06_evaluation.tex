...
\begin{tikzpicture}[
    scale=1.05,
    node distance=2.5cm,
    block/.style={rectangle, draw, fill=blue!10, text width=4.2cm, text centered, minimum height=2.0cm, rounded corners, font=\normalsize},
    testblock/.style={rectangle, draw, fill=green!10, text width=4.2cm, text centered, minimum height=2.0cm, rounded corners, font=\normalsize},
    resultblock/.style={rectangle, draw, fill=orange!10, text width=4.2cm, text centered, minimum height=2.0cm, rounded corners, font=\normalsize}
]
...
\begin{tikzpicture}[
    scale=1.05,
    node distance=2.5cm,
    layer/.style={rectangle, draw, fill=blue!15, text width=3.7cm, text centered, minimum height=2.1cm, rounded corners, font=\normalsize},
...
\begin{tikzpicture}[
    ...
    source/.style={rectangle, draw, fill=red!20, minimum width=4.2cm, minimum height=2.0cm, text centered, font=\normalsize},
...
\begin{tikzpicture}[
    scale=1.05,
    node distance=2.5cm,
    abstract/.style={rectangle, draw, fill=blue!15, text width=3.7cm, text centered, minimum height=2.1cm, rounded corners, font=\normalsize},
    bridge/.style={rectangle, draw, fill=orange!20, text width=3.7cm, text centered, minimum height=2.1cm, rounded corners, dashed, font=\normalsize},
    physical/.style={rectangle, draw, fill=green!15, text width=3.7cm, text centered, minimum height=2.1cm, rounded corners, font=\normalsize}
]
...
\begin{figure}[htbp]
\centering
\begin{tikzpicture}[scale=1.05, node distance=2cm]
...
\begin{tikzpicture}[
    scale=1.05,
    node distance=2.5cm,
    result/.style={rectangle, draw, fill=green!20, text width=3.7cm, text centered, minimum height=2.0cm, rounded corners, font=\normalsize},
    central/.style={rectangle, draw, fill=blue!20, text width=4.2cm, text centered, minimum height=2.4cm, rounded corners, very thick, font=\normalsize}
]
