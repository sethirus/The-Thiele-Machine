...
\begin{tikzpicture}[
    scale=1.05,
    node distance=3.0cm,
    block/.style={rectangle, draw, fill=blue!10, text width=4.2cm, text centered, minimum height=2.0cm, rounded corners=3pt, font=
ormalsize},
    testblock/.style={rectangle, draw, fill=green!10, text width=4.2cm, text centered, minimum height=2.0cm, rounded corners=3pt, font=
ormalsize},
    resultblock/.style={rectangle, draw, fill=orange!10, text width=4.2cm, text centered, minimum height=2.0cm, rounded corners=3pt, font=
ormalsize}
]

% Top: What we're testing
\node[block, align=center, text width=4.5cm] (theory) at (0,3) {\textbf{Theory}\\(Ch. 3-5)};
\node[block, align=center, text width=4.5cm] (impl) at (4,3) {\textbf{Implementation}\\(Ch. 4)};
\node[block, align=center, text width=4.5cm] (proofs) at (8,3) {\textbf{Proofs}\\(206 files)};

% Middle: Test categories
\node[testblock, align=center, text width=4.5cm] (iso) at (0,0) {\textbf{Isomorphism}\\3-layer match};
\node[testblock, align=center, text width=4.5cm] (chsh) at (3,0) {\textbf{CHSH}\\Bell tests};
\node[testblock, align=center, text width=4.5cm] (ledger) at (6,0) {\textbf{$\mu$-Ledger}\\Conservation};
\node[testblock, align=center, text width=4.5cm] (thermo) at (9,0) {\textbf{Thermo}\\Bridge tests};

% Bottom: Results
\node[resultblock, align=center, text width=4.5cm] (pass) at (4.5,-2.5) {\textbf{PASS}\\All tests};

% Arrows
\draw[->, line width=1.2pt] (theory) -- (iso);
\draw[->, line width=1.2pt] (theory) -- (chsh);
\draw[->, line width=1.2pt] (impl) -- (iso);
\draw[->, line width=1.2pt] (impl) -- (ledger);
\draw[->, line width=1.2pt] (proofs) -- (ledger);
\draw[->, line width=1.2pt] (proofs) -- (thermo);

\draw[->, line width=1.2pt] (iso) -- (pass);
\draw[->, line width=1.2pt] (chsh) -- (pass);
\draw[->, line width=1.2pt] (ledger) -- (pass);
\draw[->, line width=1.2pt] (thermo) -- (pass);
...
\begin{tikzpicture}[
    scale=1.05,
    node distance=3.0cm,
    layer/.style={rectangle, draw, fill=blue!15, text width=3.7cm, text centered, minimum height=2.1cm, rounded corners=3pt, font=
ormalsize},
    trace/.style={rectangle, draw, fill=green!10, text width=4.2cm, text centered, minimum height=1.2cm, font=
ormalsize},
...
% Input trace
\node[trace, align=center, text width=4.5cm] (trace) at (0,0) {\textbf{Trace}\\Instructions};

% Three layers
\node[layer, align=center, text width=4.5cm] (coq) at (4,2) {\textbf{Coq}\\Extracted semantics};
\node[layer, align=center, text width=4.5cm] (python) at (4,0) {\textbf{Python}\\Reference VM};
\node[layer, align=center, text width=4.5cm] (rtl) at (4,-2) {\textbf{RTL}\\Verilog simulation};
...
% Result
\node[draw, fill=green!30, rounded corners=3pt] (pass) at (14,0) {\textbf{PASS}};

% Arrows
\draw[->, line width=1.2pt] (trace) -- (coq);
\draw[->, line width=1.2pt] (trace) -- (python);
\draw[->, line width=1.2pt] (trace) -- (rtl);

\draw[->, line width=1.2pt] (coq) -- (s1);
\draw[->, line width=1.2pt] (python) -- (s2);
\draw[->, line width=1.2pt] (rtl) -- (s3);

\draw[->, line width=1.2pt] (s1) -- (cmp);
\draw[->, line width=1.2pt] (s2) -- (cmp);
\draw[->, line width=1.2pt] (s3) -- (cmp);

\draw[->, line width=1.2pt] (cmp) -- (pass);
...
\begin{tikzpicture}[
    scale=1.05,
    node distance=3cm,
    party/.style={circle, draw, fill=blue!12, minimum size=1.3cm, text centered, font=
ormalsize},
    source/.style={rectangle, draw, fill=red!12, minimum width=4.2cm, minimum height=2.0cm, text centered, font=
ormalsize},
    setting/.style={rectangle, draw, fill=green!10, minimum width=1.7cm, minimum height=1.3cm, text centered, font=
ormalsize}
]

% Source
\node[source, align=center, text width=4.5cm] (src) at (5,0) {\textbf{Source}\\Correlated pairs};
...
% Arrows
\draw[->, line width=1.2pt, dashed] (src) -- node[above, font=\small] {particle} (alice);
\draw[->, line width=1.2pt, dashed] (src) -- node[above, font=\small] {particle} (bob);
\draw[->, line width=1.2pt] (x) -- node[right, font=\small] {setting} (alice);
\draw[->, line width=1.2pt] (alice) -- node[right, font=\small] {outcome} (a);
\draw[->, line width=1.2pt] (y) -- node[left, font=\small] {setting} (bob);
\draw[->, line width=1.2pt] (bob) -- node[left, font=\small] {outcome} (b);

% CHSH scale below
\node at (5,-3.5) {\textbf{CHSH Value Scale}};
\draw[line width=1.2pt] (0,-4.5) -- (10,-4.5);

% Markers
\draw[line width=1.2pt] (0,-4.3) -- (0,-4.7) node[below, font=\small] {0};
\draw[line width=1.2pt, blue] (5,-4.3) -- (5,-4.7) node[below, font=\small] {2};
\draw[line width=1.2pt, red] (7.07,-4.3) -- (7.07,-4.7) node[below, font=\small] {$2\sqrt{2}$};
\draw[line width=1.2pt] (10,-4.3) -- (10,-4.7) node[below, font=\small] {4};
...
ormalsize},
    ledger/.style={rectangle, draw, fill=orange!20, minimum width=1.8cm, minimum height=1.3cm, text centered, font=
ormalsize}
, node distance=3cm]
...
\draw[->, line width=1.2pt] (s0) -- node[above, font=\small] {$+3$} (s1);
\draw[->, line width=1.2pt] (s1) -- node[above, font=\small] {$+2$} (s2);
\draw[->, line width=1.2pt] (s2) -- node[above, font=\small] {$+3$} (s3);
\draw[->, line width=1.2pt] (s3) -- node[above, font=\small] {$+4$} (s4);
...
% Monotonicity arrows
\draw[->, line width=1.2pt, red] (m0.east) -- (m1.west);
\draw[->, line width=1.2pt, red] (m1.east) -- (m2.west);
\draw[->, line width=1.2pt, red] (m2.east) -- (m3.west);
\draw[->, line width=1.2pt, red] (m3.east) -- (m4.west);
...
\begin{tikzpicture}[
    scale=1.05,
    node distance=3.0cm,
    abstract/.style={rectangle, draw, fill=blue!15, text width=3.7cm, text centered, minimum height=2.1cm, rounded corners=3pt, font=
ormalsize},
    bridge/.style={rectangle, draw, fill=orange!20, text width=3.7cm, text centered, minimum height=2.1cm, rounded corners=3pt, dashed, font=
ormalsize},
    physical/.style={rectangle, draw, fill=green!15, text width=3.7cm, text centered, minimum height=2.1cm, rounded corners=3pt, font=
ormalsize}
]

% Abstract layer
\node[abstract, align=center, text width=4.5cm] (mu) at (0,2) {\textbf{$\mu$-Ledger}\\Abstract cost};
\node[abstract, align=center, text width=4.5cm] (omega) at (4,2) {\textbf{$\Omega \to \Omega'$}\\State reduction};

% Bridge
\node[bridge, align=center, text width=4.5cm] (landauer) at (2,0) {\textbf{Landauer}\\$Q \ge kT \ln 2 \cdot \mu$};

% Physical
\node[physical, align=center, text width=4.5cm] (energy) at (0,-2) {\textbf{Energy}\\Joules};
\node[physical, align=center, text width=4.5cm] (entropy) at (4,-2) {\textbf{Entropy}\\$\Delta S_{\text{env}}$};

% Arrows
\draw[->, line width=1.2pt] (mu) -- (landauer);
\draw[->, line width=1.2pt] (omega) -- (landauer);
\draw[->, line width=1.2pt] (landauer) -- (energy);
\draw[->, line width=1.2pt] (landauer) -- (entropy);
...
\begin{figure}[htbp]
\centering
\begin{tikzpicture}[scale=1.05, node distance=2.5cm]
...
\begin{tikzpicture}[
    scale=1.05,
    node distance=3.0cm,
    result/.style={rectangle, draw, fill=green!12, text width=3.7cm, text centered, minimum height=2.0cm, rounded corners=3pt, font=
ormalsize},
    central/.style={rectangle, draw, fill=blue!12, text width=4.2cm, text centered, minimum height=2.4cm, rounded corners=3pt, line width=1.2pt, font=
ormalsize}
]

% Central validation
\node[central, align=center, text width=4.5cm] (val) at (6,0) {\textbf{Empirical}\\
\textbf{Validation}\\
Theory $=$ Practice};

% Results around
\node[result, align=center, text width=4.5cm] (iso) at (0,2) {\textbf{Isomorphism}\\3-layer match\\100\% pass};
\node[result, align=center, text width=4.5cm] (chsh) at (0,-2) {\textbf{CHSH}\\Bounds enforced\\Revelation required};
\node[result, align=center, text width=4.5cm] (ledger) at (12,2) {\textbf{$\mu$-Ledger}\\Monotonic\\Conservative};
\node[result, align=center, text width=4.5cm] (thermo) at (12,-2) {\textbf{Thermodynamic}\\Bridge validated\\Falsifiable};

% Arrows
\draw[->, line width=1.2pt] (iso) -- (val);
\draw[->, line width=1.2pt] (chsh) -- (val);
\draw[->, line width=1.2pt] (ledger) -- (val);
\draw[->, line width=1.2pt] (thermo) -- (val);
