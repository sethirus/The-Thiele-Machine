...
% Arrows
\draw[->, very thick, dashed] (src) -- node[above, yshift=6pt, pos=0.5,  very thick, dashed] (src) -- node[above, yshift=6pt, pos=0.5, font=\small] {particle} (bob);
\draw[->, very thick] (x) -- node[right, above, yshift=6pt, pos=0.5,  very thick] (alice) -- node[right, above, yshift=6pt, pos=0.5, font=\small] {outcome} (a);
\draw[->, very thick] (y) -- node[left, above, yshift=6pt, pos=0.5,  very thick] (bob) -- node[left, above, yshift=6pt, pos=0.5, font=\small] {outcome} (b);
...
% Markers
\draw[very thick, shorten >=2pt, shorten <=2pt] (0,-4.3) -- (0,-4.7) node[below, above, yshift=6pt, pos=0.5,  blue, shorten >=2pt, shorten <=2pt] (5,-4.3) -- (5,-4.7) node[below, above, yshift=6pt, pos=0.5, font=\small] {2};
\draw[very thick, red, shorten >=2pt, shorten <=2pt] (7.07,-4.3) -- (7.07,-4.7) node[below, above, yshift=6pt, pos=0.5,  shorten >=2pt, shorten <=2pt] (10,-4.3) -- (10,-4.7) node[below, above, yshift=6pt, pos=0.5, font=\small] {4};
...
\draw[->, very thick] (s0) -- node[above, yshift=6pt, pos=0.5,  very thick] (s1) -- node[above, yshift=6pt, pos=0.5, font=\small] {$+2$} (s2);
\draw[->, very thick] (s2) -- node[above, yshift=6pt, pos=0.5,  very thick] (s3) -- node[above, yshift=6pt, pos=0.5, font=\small] {$+4$} (s4);
