...
Before I dive into the Thiele Machine, I need to explain \textit{what problem it solves}. I didn't start with a formal education in any of this---I started with questions I couldn't answer. This chapter covers the concepts I had to learn:
\begin{itemize}
...
I learned all of this by pulling on threads. If you already know it, skip ahead. If you don't, this chapter is for you---written by someone who also didn't know it a year ago.
...
This raises a question that kept nagging at me: \textit{What if structural knowledge were a first-class resource that must be discovered, paid for, and accounted for?}

That question is what this thesis tries to answer.
