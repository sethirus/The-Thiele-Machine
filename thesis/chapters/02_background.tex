...
\begin{tikzpicture}[scale=1.0, node distance=2cm]
    % Three columns
    \node[draw, rounded corners, fill=green!10, minimum width=5.4cm, minimum height=3.6cm, align=center, text width=4.5cm] (shannon) at (0,0) {
        \begin{tabular}{c}
    ...
    \node[draw, rounded corners, fill=blue!10, minimum width=5.4cm, minimum height=3.6cm, align=center, text width=4.5cm] (kolmogorov) at (5,0) {
        \begin{tabular}{c}
        \textbf{Kolmogorov}\\
        $K(x) = \min|p|$\\
    ...
    \node[draw, rounded corners, fill=orange!10, minimum width=5.4cm, minimum height=3.6cm, align=center, text width=4.5cm] (mdl) at (10,0) {
        \begin{tabular}{c}
        \textbf{MDL / $\mu$-cost}\\
        $L(H) + L(D|H)$\\
    ...
    % Annotation box
    \node[draw, very thick, red, dashed, rounded corners, align=center, text width=4.5cm] at (10,-2.5) {
        \begin{tabular}{c}
...
\begin{tikzpicture}[scale=1.0, node distance=3cm]
    ...
    % Key insight
    \node[draw, very thick, dashed, rounded corners, fill=yellow!20, align=center, text width=4.5cm] at (5,-3.5) {
        \begin{tabular}{c}
...
\begin{tikzpicture}[scale=1.0, node distance=2.5cm]
    % Alice and Bob boxes
    \node[draw, very thick, rounded corners, fill=blue!10, minimum width=4.5cm, minimum height=2.6cm, align=center, text width=4.5cm] (alice) at (-4,0) {
        \begin{tabular}{c}
        \textbf{Alice}\\
        $x \in \{0,1\}$\\
        $a \in \{0,1\}$
    ...
    \node[draw, very thick, rounded corners, fill=green!10, minimum width=4.5cm, minimum height=2.6cm, align=center, text width=4.5cm] (bob) at (4,0) {
        \begin{tabular}{c}
        \textbf{Bob}\\
        $y \in \{0,1\}$\\
        $b \in \{0,1\}$
    ...
    % Entangled source
    \node[draw, very thick, rounded corners, fill=red!20, minimum width=3.5cm] (source) at (0,0) {Source};
    ...
    \begin{scope}[yshift=-3cm]
        \draw[very thick, ->] (-5,0) -- (5,0) node[right, font=\small] {$S$};
        \draw[very thick] (-4,0.1) -- (-4,-0.1) node[below, font=\small] {$-4$};
        \draw[very thick] (-2,0.1) -- (-2,-0.1) node[below, font=\small] {$-2$};
        \draw[very thick] (0,0.1) -- (0,-0.1) node[below, font=\small] {$0$};
        \draw[very thick] (2,0.1) -- (2,-0.1) node[below, font=\small] {$2$};
        \draw[very thick] (2.83,0.1) -- (2.83,-0.1) node[below, font=\small] {$2\sqrt{2}$};
        \draw[very thick] (4,0.1) -- (4,-0.1) node[below, font=\small] {$4$};
...
\begin{tikzpicture}[scale=1.05, node distance=2.5cm]
    % Coq workflow boxes
    \node[draw, very thick, rounded corners, fill=blue!10, minimum width=5.5cm, minimum height=2.1cm, align=center, text width=4.5cm] (spec) at (0,0) {
        \begin{tabular}{c}
        \textbf{Specification}\\
        \small Definitions
        \end{tabular}
    ...
    \node[draw, very thick, rounded corners, fill=green!10, minimum width=5.5cm, minimum height=2.1cm, align=center, text width=4.5cm] (theorem) at (4,0) {
        \begin{tabular}{c}
        \textbf{Theorem}\\
        \small Statement
        \end{tabular}
    ...
    \node[draw, very thick, rounded corners, fill=orange!10, minimum width=5.5cm, minimum height=2.1cm, align=center, text width=4.5cm] (proof) at (8,0) {
        \begin{tabular}{c}
        \textbf{Proof}\\
        \small Tactics
        \end{tabular}
    ...
    \node[draw, very thick, rounded corners, fill=red!10, minimum width=5.5cm, minimum height=2.1cm, align=center, text width=4.5cm] (qed) at (12,0) {
        \begin{tabular}{c}
        \textbf{Qed}\\
        \small Verified!
        \end{tabular}
    ...
    % Curry-Howard
    \node[draw, dashed, very thick, purple, rounded corners, align=center, text width=4.5cm] at (6,-2) {
        \begin{tabular}{c}
    ...
    \begin{scope}[yshift=-4cm]
        \node[draw, very thick, fill=red!20, rounded corners, minimum width=18.0cm, align=center, text width=4.5cm] at (6,0) {
            \begin{tabular}{c}
...
\begin{tikzpicture}[scale=1.05, node distance=2.5cm]
    % Central node
    \node[draw, very thick, rounded corners, fill=yellow!30, minimum width=5.4cm, minimum height=2.6cm, align=center, text width=4.5cm] (thiele) at (0,0) {
        \begin{tabular}{c}
        \textbf{Thiele Machine}\\
        \small $\mu$-accounting
        \end{tabular}
    ...
    \node[draw, very thick, rounded corners, fill=blue!15, minimum width=5.5cm, minimum height=2.2cm, align=center, text width=4.5cm] (comp) at (-5,3) {
        \begin{tabular}{c}
        \textbf{Computation}\\
        \small TM, RAM\\
        \small Blindness
    ...
    \node[draw, very thick, rounded corners, fill=green!15, minimum width=5.5cm, minimum height=2.2cm, align=center, text width=4.5cm] (info) at (5,3) {
        \begin{tabular}{c}
        \textbf{Information}\\
        \small Shannon, K(x)\\
        \small MDL
    ...
    \node[draw, very thick, rounded corners, fill=red!15, minimum width=5.5cm, minimum height=2.2cm, align=center, text width=4.5cm] (phys) at (-5,-3) {
        \begin{tabular}{c}
        \textbf{Physics}\\
        \small Landauer\\
    ...
    \node[draw, very thick, rounded corners, fill=purple!15, minimum width=5.5cm, minimum height=2.2cm, align=center, text width=4.5cm] (quantum) at (5,-3) {
        \begin{tabular}{c}
        \textbf{Quantum}\\
        \small Bell, CHSH\\
        \small Tsirelson
    ...
    % Verification layer
    \node[draw, very thick, rounded corners, fill=orange!20, minimum width=14.4cm, align=center, text width=4.5cm] (verify) at (0,-5.5) {
        \begin{tabular}{c}
