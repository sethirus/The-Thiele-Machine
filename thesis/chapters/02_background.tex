...
\begin{tikzpicture}[scale=0.8]
    ...
    % Head
    \draw[thick, blue, ->, >=stealth] (4.5,2) -- (4.5,1.1);
    \node[blue] at (4.5,2.3) {Head};
    
    % Control unit
    \draw[thick, rounded corners, fill=blue!10] (3,3) rectangle (6,4.5);
    \node at (4.5,4) {Control};
    \node at (4.5,3.5) {$q \in Q$};
    
    % Transition function
    \draw[thick, ->, >=stealth] (6,3.75) -- (7.5,3.75);
    \node[right] at (7.5,3.75) {$\delta(q,\gamma) \to (q',\gamma',d)$};
    
    % Labels
    \node[below] at (4.5,-0.3) {Infinite tape $\Gamma^*$};
    \draw[<->, >=stealth] (-0.5,0.5) -- (-0.5,0.5) node[left] {$\cdots$};
    \draw[<->, >=stealth] (9.5,0.5) -- (9.5,0.5) node[right] {$\cdots$};
    
    % Blindness annotation
    \draw[thick, red, dashed] (4,0) rectangle (5,1);
...
\begin{tikzpicture}[scale=0.9]
    % Three columns
    \node[draw, rounded corners, fill=green!10, minimum width=3cm, minimum height=2cm] (shannon) at (0,0) {
        \begin{tabular}{c}
    ...
    \node[draw, rounded corners, fill=blue!10, minimum width=3cm, minimum height=2cm] (kolmogorov) at (5,0) {
        \begin{tabular}{c}
        \textbf{Kolmogorov}\\
        $K(x) = \min|p|$\\
    ...
    \node[draw, rounded corners, fill=orange!10, minimum width=3cm, minimum height=2cm] (mdl) at (10,0) {
        \begin{tabular}{c}
        \textbf{MDL / $\mu$-cost}\\
        $L(H) + L(D|H)$\\
    ...
    % Arrows
    \draw[thick, ->, >=stealth] (shannon) -- (kolmogorov) node[midway, above] {\small generalizes};
    \draw[thick, ->, >=stealth] (kolmogorov) -- (mdl) node[midway, above] {\small approximates};
    
    % Annotation box
    \node[draw, thick, red, dashed, rounded corners] at (10,-2.5) {
        \begin{tabular}{c}
    ...
    \draw[thick, red, ->, >=stealth, dashed] (10,-1.2) -- (10,-1.8);
\end{tikzpicture}
...
\begin{tikzpicture}[scale=0.85]
    ...
    \begin{scope}[xshift=5cm]
        ...
        % Door
        \draw[thick, blue, fill=blue!30] (-0.1,-0.3) rectangle (0.1,0.3);
        
        % Demon
        \node[draw, circle, fill=green!30, minimum size=0.8cm] (demon) at (0,2) {D};
        \draw[thick, ->, >=stealth] (demon) -- (0,0.5);
...
\begin{tikzpicture}[scale=0.9]
    ...
    \node[draw, thick, rounded corners, fill=blue!15, minimum width=3cm, minimum height=4cm] (abstract) at (0,0) {};
    ...
    \node[draw, thick, rounded corners, fill=green!15, minimum width=3cm, minimum height=4cm] (bridge) at (5,0) {};
    ...
    \node[draw, thick, rounded corners, fill=red!15, minimum width=3cm, minimum height=4cm] (physical) at (10,0) {};
    ...
    % Arrows
    \draw[thick, <->, >=stealth] (1.8,0) -- (3.2,0) node[midway, above] {\small maps to};
    \draw[thick, <->, >=stealth] (6.8,0) -- (8.2,0) node[midway, above] {\small maps to};
    
    % Key insight
    \node[draw, thick, dashed, rounded corners, fill=yellow!20] at (5,-3.5) {
        \begin{tabular}{c}
...
\begin{tikzpicture}[scale=0.9]
    % Alice and Bob boxes
    \node[draw, thick, rounded corners, fill=blue!10, minimum width=2cm, minimum height=1.5cm] (alice) at (-4,0) {
        \begin{tabular}{c}
        \textbf{Alice}\\
        $x \in \{0,1\}$\\
        $a \in \{0,1\}$
    ...
    \node[draw, thick, rounded corners, fill=green!10, minimum width=2cm, minimum height=1.5cm] (bob) at (4,0) {
        \begin{tabular}{c}
        \textbf{Bob}\\
        $y \in \{0,1\}$\\
        $b \in \{0,1\}$
    ...
    % Entangled source
    \node[draw, thick, rounded corners, fill=red!20, minimum width=1.5cm] (source) at (0,0) {Source};
    \draw[thick, red, decorate, decoration={snake, amplitude=2pt}] (source) -- (alice);
    \draw[thick, red, decorate, decoration={snake, amplitude=2pt}] (source) -- (bob);
    
    % CHSH value scale
    \begin{scope}[yshift=-3cm]
        \draw[thick, ->] (-5,0) -- (5,0) node[right] {$S$};
        ...
        \draw[thick] (2,0.1) -- (2,-0.1) node[below] {$2$};
        \draw[thick] (2.83,0.1) -- (2.83,-0.1) node[below] {$2\sqrt{2}$};
        \draw[thick] (4,0.1) -- (4,-0.1) node[below] {$4$};
        ...
        \node[blue] at (2.4,0.55) {\tiny Q};
        
        \fill[red!30, opacity=0.5] (2.83,0.3) rectangle (4,0.8);
        \node[red!70!black] at (3.4,0.55) {\small Supra-Q};
        
        % Bounds
        \draw[thick, green!50!black, dashed] (2,0) -- (2,1);
        \draw[thick, blue, dashed] (2.83,0) -- (2.83,1);
...
\begin{tikzpicture}[scale=0.85]
    % Coq workflow boxes
    \node[draw, thick, rounded corners, fill=blue!10, minimum width=2.5cm, minimum height=1cm] (spec) at (0,0) {
        \begin{tabular}{c}
        \textbf{Specification}\\
        \small Definitions
        \end{tabular}
    ...
    \node[draw, thick, rounded corners, fill=green!10, minimum width=2.5cm, minimum height=1cm] (theorem) at (4,0) {
        \begin{tabular}{c}
        \textbf{Theorem}\\
        \small Statement
        \end{tabular}
    ...
    \node[draw, thick, rounded corners, fill=orange!10, minimum width=2.5cm, minimum height=1cm] (proof) at (8,0) {
        \begin{tabular}{c}
        \textbf{Proof}\\
        \small Tactics
        \end{tabular}
    ...
    \node[draw, thick, rounded corners, fill=red!10, minimum width=2.5cm, minimum height=1cm] (qed) at (12,0) {
        \begin{tabular}{c}
        \textbf{Qed}\\
        \small Verified!
        \end{tabular}
    ...
    % Arrows
    \draw[thick, ->, >=stealth] (spec) -- (theorem);
    \draw[thick, ->, >=stealth] (theorem) -- (proof);
    \draw[thick, ->, >=stealth] (proof) -- (qed);
    
    % Curry-Howard
    \node[draw, dashed, thick, purple, rounded corners] at (6,-2) {
        \begin{tabular}{c}
    ...
    \draw[thick, purple, ->, >=stealth, dashed] (6,-0.8) -- (6,-1.3);
    
    % Inquisitor Standard
    \begin{scope}[yshift=-4cm]
        \node[draw, thick, fill=red!20, rounded corners, minimum width=10cm] at (6,0) {
            \begin{tabular}{c}
...
\begin{tikzpicture}[scale=0.75]
    % Central node
    \node[draw, thick, rounded corners, fill=yellow!30, minimum width=3cm, minimum height=1.5cm] (thiele) at (0,0) {
        \begin{tabular}{c}
        \textbf{Thiele Machine}\\
        \small $\mu$-accounting
        \end{tabular}
    ...
    \node[draw, thick, rounded corners, fill=blue!15, minimum width=2.5cm, minimum height=1.2cm] (comp) at (-5,3) {
        \begin{tabular}{c}
        \textbf{Computation}\\
        \small TM, RAM\\
        \small Blindness
    ...
    \node[draw, thick, rounded corners, fill=green!15, minimum width=2.5cm, minimum height=1.2cm] (info) at (5,3) {
        \begin{tabular}{c}
        \textbf{Information}\\
        \small Shannon, K(x)\\
        \small MDL
    ...
    \node[draw, thick, rounded corners, fill=red!15, minimum width=2.5cm, minimum height=1.2cm] (phys) at (-5,-3) {
        \begin{tabular}{c}
        \textbf{Physics}\\
        \small Landauer\\
    ...
    \node[draw, thick, rounded corners, fill=purple!15, minimum width=2.5cm, minimum height=1.2cm] (quantum) at (5,-3) {
        \begin{tabular}{c}
        \textbf{Quantum}\\
        \small Bell, CHSH\\
        \small Tsirelson
    ...
    % Arrows to center
    \draw[thick, ->, >=stealth] (comp) -- (thiele) node[midway, above, sloped] {\small structure-aware};
    \draw[thick, ->, >=stealth] (info) -- (thiele) node[midway, above, sloped] {\small $\mu$-cost basis};
    \draw[thick, ->, >=stealth] (phys) -- (thiele) node[midway, below, sloped] {\small cost justification};
    \draw[thick, ->, >=stealth] (quantum) -- (thiele) node[midway, below, sloped] {\small $2\sqrt{2}$ derivation};
    
    % Verification layer
    \node[draw, thick, rounded corners, fill=orange!20, minimum width=8cm] (verify) at (0,-5.5) {
        \begin{tabular}{c}
        \textbf{Formal Verification} (Coq)\\
        \small 206 proofs $\cdot$ Inquisitor Standard $\cdot$ Zero axioms/admits
        \end{tabular}
    };
    \draw[thick, ->, >=stealth] (thiele) -- (verify);
\end{tikzpicture}
