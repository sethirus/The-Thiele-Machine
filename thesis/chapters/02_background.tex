...
\begin{figure}[htbp]
\centering
\begin{tikzpicture}[scale=1.05, node distance=3cm]
    % Tape
    ...
    % Head
    \draw[line width=1.2pt, blue, ->, >=Stealth] (4.5,2) -- (4.5,1.1);
    \node[blue] at (4.5,2.3) {Head};
    
    % Control unit
    \draw[line width=1.2pt, rounded corners=3pt, fill=blue!10] (3,3) rectangle (6,4.5);
    \node at (4.5,4) {Control};
    \node at (4.5,3.5) {$q \in Q$};
    
    % Transition function
    \draw[line width=1.2pt, ->, >=Stealth] (6,3.75) -- (7.5,3.75);
    \node[right] at (7.5,3.75) {$\delta(q,\gamma) \to (q',\gamma',d)$};
    
    % Labels
    \node[below] at (4.5,-0.3) {Infinite tape $\Gamma^*$};
    \node[left, font=\small] at (-0.5,0.5) {$\cdots$};
    \node[right, font=\small] at (9.5,0.5) {$\cdots$};
    
    % Blindness annotation
    \draw[line width=1.2pt, red, dashed] (4,0) rectangle (5,1);
...
\begin{tikzpicture}[scale=1.0, node distance=2.5cm]
    % Three columns
    \node[draw, rounded corners=3pt, fill=green!10, minimum width=5.4cm, minimum height=3.6cm, align=center, text width=4.5cm] (shannon) at (0,0) {
        \begin{tabular}{c}
    ...
    \node[draw, rounded corners=3pt, fill=blue!10, minimum width=5.4cm, minimum height=3.6cm, align=center, text width=4.5cm] (kolmogorov) at (5,0) {
        \begin{tabular}{c}
        \textbf{Kolmogorov}\\
        $K(x) = \min|p|$\\
    ...
    \node[draw, rounded corners=3pt, fill=orange!10, minimum width=5.4cm, minimum height=3.6cm, align=center, text width=4.5cm] (mdl) at (10,0) {
        \begin{tabular}{c}
        \textbf{MDL / $\mu$-cost}\\
        $L(H) + L(D|H)$\\
    ...
    % Arrows
    \draw[line width=1.2pt, ->, >=Stealth] (shannon) -- (kolmogorov) node[pos=0.5, font=\small, above, yshift=6pt] {\small generalizes};
    \draw[line width=1.2pt, ->, >=Stealth] (kolmogorov) -- (mdl) node[pos=0.5, font=\small, above, yshift=6pt] {\small approximates};
    
    % Annotation box
    \node[draw, line width=1.2pt, red, dashed, rounded corners=3pt, align=center, text width=4.5cm] at (10,-2.5) {
        \begin{tabular}{c}
    ...
    \draw[line width=1.2pt, red, ->, >=Stealth, dashed] (10,-1.2) -- (10,-1.8);
\end{tikzpicture}
...
\begin{tikzpicture}[scale=1.05, node distance=3cm]
    ...
    \begin{scope}[xshift=-5cm]
        % Two-to-one mapping
        \node[draw, circle, fill=blue!12] (a) at (0,1) {0};
        \node[draw, circle, fill=blue!12] (b) at (0,-1) {1};
        \node[draw, circle, fill=red!12] (c) at (3,0) {0};
        
        \draw[line width=1.2pt, ->, >=Stealth] (a) -- (c);
        \draw[line width=1.2pt, ->, >=Stealth] (b) -- (c);
        
        % Heat release
        \draw[line width=1.2pt, red, ->] (3.5,0) -- (5,0);
        \node[red] at (5.5,0) {$Q$};
    ...
    \begin{scope}[xshift=5cm]
        ...
        \draw[line width=1.2pt] (0,-1.5) -- (0,-0.3);
        \draw[line width=1.2pt] (0,0.3) -- (0,1.5);
        
        % Door
        \draw[line width=1.2pt, blue, fill=blue!30] (-0.1,-0.3) rectangle (0.1,0.3);
        
        % Demon
        \node[draw, circle, fill=green!30, minimum size=0.8cm] (demon) at (0,2) {D};
        \draw[line width=1.2pt, ->, >=Stealth] (demon) -- (0,0.5);
...
\begin{figure}[htbp]
\centering
\begin{tikzpicture}[scale=1.0, node distance=3cm]
    % Three columns: Abstract, Bridge, Physical
    \node[draw, line width=1.2pt, rounded corners=3pt, fill=blue!15, minimum width=5.4cm, minimum height=7.2cm] (abstract) at (0,0) {};
    ...
    \node[draw, line width=1.2pt, rounded corners=3pt, fill=green!15, minimum width=5.4cm, minimum height=7.2cm] (bridge) at (5,0) {};
    ...
    \node[draw, line width=1.2pt, rounded corners=3pt, fill=red!15, minimum width=5.4cm, minimum height=7.2cm] (physical) at (10,0) {};
    ...
    % Arrows
    \draw[line width=1.2pt, <->, >=Stealth] (1.8,0) -- (3.2,0) node[pos=0.5, font=\small, above, yshift=6pt] {\small maps to};
    \draw[line width=1.2pt, <->, >=Stealth] (6.8,0) -- (8.2,0) node[pos=0.5, font=\small, above, yshift=6pt] {\small maps to};
    
    % Key insight
    \node[draw, line width=1.2pt, dashed, rounded corners=3pt, fill=yellow!15, align=center, text width=4.5cm] at (5,-3.5) {
        \begin{tabular}{c}
...
\begin{figure}[htbp]
\centering
\begin{tikzpicture}[scale=1.0, node distance=3.0cm]
    % Alice and Bob boxes
    \node[draw, line width=1.2pt, rounded corners=3pt, fill=blue!10, minimum width=4.5cm, minimum height=2.6cm, align=center, text width=4.5cm] (alice) at (-4,0) {
        \begin{tabular}{c}
        \textbf{Alice}\\
        $x \in \{0,1\}$\\
        $a \in \{0,1\}$
    ...
    \node[draw, line width=1.2pt, rounded corners=3pt, fill=green!10, minimum width=4.5cm, minimum height=2.6cm, align=center, text width=4.5cm] (bob) at (4,0) {
        \begin{tabular}{c}
        \textbf{Bob}\\
        $y \in \{0,1\}$\\
        $b \in \{0,1\}$
    ...
    % Entangled source
    \node[draw, line width=1.2pt, rounded corners=3pt, fill=red!12, minimum width=3.5cm] (source) at (0,0) {Source};
    \draw[line width=1.2pt, red, decorate, decoration={snake, amplitude=2pt}] (source) -- (alice);
    \draw[line width=1.2pt, red, decorate, decoration={snake, amplitude=2pt}] (source) -- (bob);
    
    % CHSH value scale
    \begin{scope}[yshift=-3cm]
        \draw[line width=1.2pt, ->] (-5,0) -- (5,0) node[right, font=\small] {$S$};
        \draw[line width=1.2pt] (-4,0.1) -- (-4,-0.1) node[below, font=\small] {$-4$};
        \draw[line width=1.2pt] (-2,0.1) -- (-2,-0.1) node[below, font=\small] {$-2$};
        \draw[line width=1.2pt] (0,0.1) -- (0,-0.1) node[below, font=\small] {$0$};
        \draw[line width=1.2pt] (2,0.1) -- (2,-0.1) node[below, font=\small] {$2$};
        \draw[line width=1.2pt] (2.83,0.1) -- (2.83,-0.1) node[below, font=\small] {$2\sqrt{2}$};
        \draw[line width=1.2pt] (4,0.1) -- (4,-0.1) node[below, font=\small] {$4$};
        ...
        % Bounds
        \draw[line width=1.2pt, green!50!black, dashed] (2,0) -- (2,1);
        \draw[line width=1.2pt, blue, dashed] (2.83,0) -- (2.83,1);
        \draw[line width=1.2pt, red, dashed] (4,0) -- (4,1);
    \end{scope}
    
    % CHSH formula
    \node at (0,-5.5) {$S = E(0,0) + E(0,1) + E(1,0) - E(1,1)$};
\end{tikzpicture}
\caption{The Bell-CHSH experiment. Alice and Bob share an entangled state from a source. The CHSH value $S$ is bounded by 2 for classical (local hidden variable) theories, $2\sqrt{2}$ for quantum mechanics, and 4 algebraically. The Thiele Machine derives $2\sqrt{2}$ from $\mu$-accounting.}
...
\begin{itemize}
    ...
    \item \textbf{Supra-quantum region (red, $2\sqrt{2} < |S| \le 4$):} Algebraically possible but not realized by quantum mechanics. Why does nature stop at $2\sqrt{2}$? This is the mystery the thesis addresses.
    
    \item \textbf{Vertical dashed lines:} Mark boundaries at $S=2$ (classical), $S=2\sqrt{2}$ (Tsirelson), $S=4$ (algebraic).
\end{itemize}
...
\textbf{Key insight:} Quantum mechanics permits correlations up to $2\sqrt{2}$ but no higher. The Thiele Machine \textit{derives} this bound from $\mu$-accounting: achieving $S > 2$ requires $\mu > 0$ (structural cost), but the $\mu=0$ class naturally caps at $2\sqrt{2}$. This provides an information-theoretic explanation for Tsirelson's bound.
...
\begin{figure}[htbp]
\centering
\begin{tikzpicture}[scale=1.05, node distance=3.0cm]
    % Coq workflow boxes
    \node[draw, line width=1.2pt, rounded corners=3pt, fill=blue!10, minimum width=5.5cm, minimum height=2.1cm, align=center, text width=4.5cm] (spec) at (0,0) {
        \begin{tabular}{c}
        \textbf{Specification}\\
        \small Definitions
        \end{tabular}
    ...
    \node[draw, line width=1.2pt, rounded corners=3pt, fill=green!10, minimum width=5.5cm, minimum height=2.1cm, align=center, text width=4.5cm] (theorem) at (4,0) {
        \begin{tabular}{c}
        \textbf{Theorem}\\
        \small Statement
        \end{tabular}
    ...
    \node[draw, line width=1.2pt, rounded corners=3pt, fill=orange!10, minimum width=5.5cm, minimum height=2.1cm, align=center, text width=4.5cm] (proof) at (8,0) {
        \begin{tabular}{c}
        \textbf{Proof}\\
        \small Tactics
        \end{tabular}
    ...
    \node[draw, line width=1.2pt, rounded corners=3pt, fill=red!10, minimum width=5.5cm, minimum height=2.1cm, align=center, text width=4.5cm] (qed) at (12,0) {
        \begin{tabular}{c}
        \textbf{Qed}\\
        \small Verified!
        \end{tabular}
    ...
    % Arrows
    \draw[line width=1.2pt, ->, >=Stealth] (spec) -- (theorem);
    \draw[line width=1.2pt, ->, >=Stealth] (theorem) -- (proof);
    \draw[line width=1.2pt, ->, >=Stealth] (proof) -- (qed);
    
    % Curry-Howard
    \node[draw, dashed, line width=1.2pt, purple, rounded corners=3pt, align=center, text width=4.5cm] at (6,-2) {
        \begin{tabular}{c}
    ...
    \draw[line width=1.2pt, purple, ->, >=Stealth, dashed] (6,-0.8) -- (6,-1.3);
    
    % Inquisitor Standard
    \begin{scope}[yshift=-4cm]
        \node[draw, line width=1.2pt, fill=red!12, rounded corners=3pt, minimum width=18.0cm, align=center, text width=4.5cm] at (6,0) {
            \begin{tabular}{c}
...
\begin{tikzpicture}[scale=1.05, node distance=3.0cm]
    % Central node
    \node[draw, line width=1.2pt, rounded corners=3pt, fill=yellow!30, minimum width=5.4cm, minimum height=2.6cm, align=center, text width=4.5cm] (thiele) at (0,0) {
        \begin{tabular}{c}
        \textbf{Thiele Machine}\\
        \small $\mu$-accounting
        \end{tabular}
    ...
    \node[draw, line width=1.2pt, rounded corners=3pt, fill=blue!15, minimum width=5.5cm, minimum height=2.2cm, align=center, text width=4.5cm] (comp) at (-5,3) {
        \begin{tabular}{c}
        \textbf{Computation}\\
        \small TM, RAM\\
        \small Blindness
    ...
    \node[draw, line width=1.2pt, rounded corners=3pt, fill=green!15, minimum width=5.5cm, minimum height=2.2cm, align=center, text width=4.5cm] (info) at (5,3) {
        \begin{tabular}{c}
        \textbf{Information}\\
        \small Shannon, K(x)\\
        \small MDL
    ...
    \node[draw, line width=1.2pt, rounded corners=3pt, fill=red!15, minimum width=5.5cm, minimum height=2.2cm, align=center, text width=4.5cm] (phys) at (-5,-3) {
        \begin{tabular}{c}
        \textbf{Physics}\\
        \small Landauer\\
    ...
    \node[draw, line width=1.2pt, rounded corners=3pt, fill=purple!15, minimum width=5.5cm, minimum height=2.2cm, align=center, text width=4.5cm] (quantum) at (5,-3) {
        \begin{tabular}{c}
        \textbf{Quantum}\\
        \small Bell, CHSH\\
        \small Tsirelson
    ...
    % Arrows to center
    \draw[line width=1.2pt, ->, >=Stealth] (comp) -- (thiele) node[midway, above, sloped] {\small structure-aware};
    \draw[line width=1.2pt, ->, >=Stealth] (info) -- (thiele) node[midway, above, sloped] {\small $\mu$-cost basis};
    \draw[line width=1.2pt, ->, >=Stealth] (phys) -- (thiele) node[midway, below, sloped] {\small cost justification};
    \draw[line width=1.2pt, ->, >=Stealth] (quantum) -- (thiele) node[midway, below, sloped] {\small $2\sqrt{2}$ derivation};
    
    % Verification layer
    \node[draw, line width=1.2pt, rounded corners=3pt, fill=orange!20, minimum width=14.4cm, align=center, text width=4.5cm] (verify) at (0,-5.5) {
        \begin{tabular}{c}
        \textbf{Formal Verification} (Coq)\\
        \small 206 proofs $\cdot$ Inquisitor Standard $\cdot$ Zero axioms/admits
        \end{tabular}
    };
    \draw[line width=1.2pt, ->, >=Stealth] (thiele) -- (verify);
\end{tikzpicture}
