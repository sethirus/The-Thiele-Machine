...
For the Thiele Machine, this matters because the claims are not hand-waved. The 285 Coq files containing 2,316 theorems and lemmas were all checked by the compiler. Every property---$\mu$-monotonicity, No Free Insight, observational no-signaling, oracle impossibility---is established by a proof that the machine accepted, not by an argument I wrote in prose.
