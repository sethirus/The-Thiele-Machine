...
\begin{enumerate}
    \item \textbf{Formally proven}: Machine-checked proofs in the Coq proof assistant (2,154 theorems and lemmas across 272 files, totaling 73,016 lines)
    \item \textbf{Implemented}: Working code in Python (20,786 lines) and synthesizable Verilog RTL (unified design, 3,871 lines across 11 files)
