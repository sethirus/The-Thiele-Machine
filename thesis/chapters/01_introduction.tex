...
\end{tikzpicture}
\caption{The No Free Insight theorem visualized. Reducing the search space from $\Omega$ to $\Omega'$ requires paying $\mu$-cost. \textbf{Proven:} $\Delta\mu \ge |\phi|_{\text{bits}}$ for any formula $\phi$ (StateSpaceCounting.v). Under optimal encoding, this establishes $\Delta\mu \ge \log_2(\Omega) - \log_2(\Omega')$ as the information-theoretic minimum. This is a conservation law: insight costs information.}
