...
\begin{tikzpicture}[
    scale=1.0,
    node distance=2.5cm,
    box/.style={rectangle, draw, rounded corners, minimum width=5.0cm, minimum height=2.0cm, align=center, fill=blue!10},
...
\node[box, fill=yellow!30, minimum width=5.0cm, align=center, text width=4.5cm, font=\normalsize] (mu) at (0, 0) {$\mu$-bit\\Accounting};
...
\begin{tikzpicture}[
    scale=1.05,
    node distance=2.5cm,
    component/.style={rectangle, draw, rounded corners, minimum width=4.5cm, minimum height=2.0cm, align=center, very thick, font=\normalsize},
    arrow/.style={->, very thick, >=stealth},
    every node/.style={font=\normalsize}
]
...
% μ-Ledger (central)
\node[component, fill=red!20, minimum width=5.5cm, minimum height=2.2cm, align=center, text width=4.5cm, font=\normalsize] (mu) at (0, 0) {$\mu$-Ledger\\(monotonic)};
...
% The key equation
\node[draw, very thick, fill=yellow!20, rounded corners, align=center, text width=4.5cm] at (4, -5.5) {
...
% Layer 2: Python
\node[layer, fill=blue!20, align=center, text width=4.5cm] (python) at (0, 2) {
...
% Layer 3: Hardware
\node[layer, fill=green!20, align=center, text width=4.5cm] (rtl) at (0, 0) {
