...
I use SMT-LIB 2.0 syntax for canonical encoding, making $\mu$-costs implementation-independent. The total structural cost:
\[
...
\textbf{The Inquisitor Standard:} I enforce a zero-tolerance policy. No \texttt{Admitted}. No \texttt{admit} tactics. No \texttt{Axiom} declarations. The \path{scripts/inquisitor.py} tool scans every Coq file and blocks commits that violate this. If a theorem says ``Proven,'' it's actually proven.
