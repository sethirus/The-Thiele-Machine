...
\begin{tikzpicture}[scale=1.8, 
    node distance=3cm,
    layer/.style={rectangle, draw, rounded corners=3pt, minimum width=5.5cm, minimum height=2.0cm, align=center, fill=blue!10},
    hw/.style={rectangle, draw, rounded corners=3pt, minimum width=5.5cm, minimum height=2.0cm, align=center, fill=green!15},
    demo/.style={rectangle, draw, rounded corners=3pt, minimum width=5.5cm, minimum height=2.0cm, align=center, fill=yellow!15},
    arrow/.style={->, >=Stealth, thick}
]
    % 3 Layers
    \node[layer, align=center, text width=4.5cm] (coq) at (-3, 2) {Coq\\Proofs};
    \node[layer, align=center, text width=4.5cm] (python) at (0, 2) {Python\\VM};
    \node[layer, align=center, text width=4.5cm] (verilog) at (3, 2) {Verilog\\RTL};
    
    % Isomorphism
    \draw[<->, line width=1.2pt, red] (coq) -- (python);
    \draw[<->, line width=1.2pt, red] (python) -- (verilog);
    \node[font=
...
ormalsize, text=red] at (1.5, 2.4) {$\cong$};
    ...
    % Hardware modules
    \node[hw, align=center, text width=4.5cm] (cpu) at (-3, 0) {CPU\\Core};
    \node[hw] (alu) at (0, 0) {$\mu$-ALU};
    \node[hw, align=center, text width=4.5cm] (serial) at (3, 0) {State\\Serializer};
    
    % Demos
    \node[demo, align=center, text width=4.5cm] (chsh) at (-1.5, -2) {CHSH\\Demo};
    \node[demo, align=center, text width=4.5cm] (impossibility) at (1.5, -2) {Impossibility\\Demo};
    ...
    % Synthesis target
    \node[draw, rounded corners=3pt, fill=gray!10, font=
ormalsize, align=center, text width=4.5cm] at (0, -3.5) {Target: Xilinx 7-series FPGA\\125 MHz, 2,847 LUTs};
\end{tikzpicture}
...
\begin{tikzpicture}[scale=1.8, 
    node distance=3.0cm,
    reg/.style={rectangle, draw, minimum width=4.5cm, minimum height=2.0cm, align=center, fill=blue!10},
    op/.style={rectangle, draw, minimum width=3.5cm, minimum height=2.0cm, align=center, fill=green!15},
    arrow/.style={->, >=Stealth, thick}
]
    % Inputs
    \node[reg, align=center, text width=4.5cm] (a) at (-2, 2) {Operand A\\Q16.16};
    \node[reg, align=center, text width=4.5cm] (b) at (2, 2) {Operand B\\Q16.16};
    ...
    % Output
    \node[reg, fill=yellow!15, align=center, text width=4.5cm] (result) at (0, -1.5) {Result\\Q16.16};
    ...
    % Key property
    \node[draw, rounded corners=3pt, fill=red!15, font=
ormalsize] at (0, -3) {\textbf{Key}: $\mu$ only increases at ledger boundary};
    
    % LOG2 LUT
    \node[draw, rounded corners=3pt, fill=gray!10, font=
ormalsize, align=center, text width=4.5cm] at (4.5, 0) {256-entry\\LOG2 LUT};
\end{tikzpicture}
...
\begin{tikzpicture}[scale=1.8, 
    node distance=3cm,
    layer/.style={rectangle, draw, rounded corners=3pt, minimum width=4.5cm, minimum height=2.0cm, align=center, fill=blue!10},
    compare/.style={diamond, draw, aspect=2, fill=yellow!15},
    result/.style={rectangle, draw, rounded corners=3pt, minimum width=3.5cm, minimum height=2.0cm, align=center},
    arrow/.style={->, >=Stealth, thick}
]
    % Program
    \node[rectangle, draw, rounded corners=3pt, fill=gray!10] (prog) at (0, 2.5) {Test Program};
    
    % Layers
    \node[layer, align=center, text width=4.5cm] (python) at (-3, 1) {Python\\VM};
    \node[layer, align=center, text width=4.5cm] (extracted) at (0, 1) {Extracted\\Runner};
    \node[layer, align=center, text width=4.5cm] (rtl) at (3, 1) {RTL\\Simulation};
...
ormalsize] (s3) at (3, -0.3) {pc, $\mu$, regs};
    ...
    % Results
    \node[result, fill=green!12] (pass) at (-1.5, -3) {PASS};
    \node[result, fill=red!12] (fail) at (1.5, -3) {FAIL};
    ...
    \draw[arrow] (cmp) -- node[left,  above, yshift=6pt, pos=0.5, font=\small] {Yes} (pass);
    \draw[arrow] (cmp) -- node[right,  above, yshift=6pt, pos=0.5, font=\small] {No} (fail);
...
\begin{tikzpicture}[scale=1.8, 
    node distance=3.0cm,
    result/.style={rectangle, draw, rounded corners=3pt, minimum width=5.4cm, minimum height=2.0cm, align=center, fill=green!15},
    central/.style={rectangle, draw, rounded corners=3pt, minimum width=7.2cm, minimum height=2.1cm, align=center, fill=yellow!15},
    arrow/.style={->, >=Stealth, thick}
]
    % Results
    \node[result, align=center, text width=4.5cm] (rtl) at (-3, 1.5) {Synthesizable\\RTL};
    \node[result, align=center, text width=4.5cm] (alu) at (3, 1.5) {$\mu$-ALU\\No subtract};
    \node[result, align=center, text width=4.5cm] (iso) at (-3, -1.5) {3-Layer\\Isomorphism};
    \node[result, align=center, text width=4.5cm] (demos) at (3, -1.5) {Demonstrations\\CHSH, etc.};
    
    % Central
    \node[central, align=center, text width=4.5cm] (central) at (0, 0) {\textbf{Realizable}\\Architecture};
