...
The serializer logic is integrated into the RTL testbench (\texttt{rtl\_harness/testbench/thiele\_cpu\_kami\_tb.v}), which emits the Canonical Serialization Format (CSF). JSON snapshots used by the isomorphism harness come from the RTL testbench (\texttt{thielecpu/hardware/testbench/thiele\_cpu\_tb.v}), not from a standalone serializer module.
