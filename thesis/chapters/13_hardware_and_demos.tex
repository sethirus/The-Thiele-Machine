...
\begin{tikzpicture}[scale=1.8, 
    node distance=3cm,
    layer/.style={rectangle, draw, rounded corners, minimum width=4.6cm, minimum height=1.4cm, align=center, fill=blue!10},
    hw/.style={rectangle, draw, rounded corners, minimum width=4.6cm, minimum height=1.4cm, align=center, fill=green!15},
    demo/.style={rectangle, draw, rounded corners, minimum width=4.6cm, minimum height=1.4cm, align=center, fill=yellow!20},
...
\begin{tikzpicture}[scale=1.8, 
    node distance=2.5cm,
    reg/.style={rectangle, draw, minimum width=3.6cm, minimum height=1.1cm, align=center, fill=blue!10},
    op/.style={rectangle, draw, minimum width=2.6cm, minimum height=1.1cm, align=center, fill=green!15},
    arrow/.style={->, >=Stealth, thick}
]
    % Inputs
...
\begin{tikzpicture}[scale=1.8, 
    node distance=3cm,
    layer/.style={rectangle, draw, rounded corners, minimum width=3.6cm, minimum height=1.4cm, align=center, fill=blue!10},
    compare/.style={diamond, draw, aspect=2, fill=yellow!20},
    result/.style={rectangle, draw, rounded corners, minimum width=2.6cm, minimum height=1.1cm, align=center},
    arrow/.style={->, >=Stealth, thick}
]
    % Program
