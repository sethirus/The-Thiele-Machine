...
\begin{tikzpicture}[scale=1.8, 
    node distance=3cm,
    layer/.style={rectangle, draw, rounded corners, minimum width=5.5cm, minimum height=2.0cm, align=center, fill=blue!10},
    hw/.style={rectangle, draw, rounded corners, minimum width=5.5cm, minimum height=2.0cm, align=center, fill=green!15},
    demo/.style={rectangle, draw, rounded corners, minimum width=5.5cm, minimum height=2.0cm, align=center, fill=yellow!20},
...
\begin{tikzpicture}[scale=1.8, 
    ...
    % Output
    \node[reg, fill=yellow!20, align=center, text width=4.5cm] (result) at (0, -1.5) {Result\\Q16.16};
...
\begin{tikzpicture}[scale=1.8, 
    node distance=3cm,
    layer/.style={rectangle, draw, rounded corners, minimum width=4.5cm, minimum height=2.0cm, align=center, fill=blue!10},
    compare/.style={diamond, draw, aspect=2, fill=yellow!20},
    result/.style={rectangle, draw, rounded corners, minimum width=3.5cm, minimum height=2.0cm, align=center},
    arrow/.style={->, >=Stealth, thick}
]
    % Program
...
\begin{tikzpicture}[scale=1.8, 
    node distance=2.5cm,
    result/.style={rectangle, draw, rounded corners, minimum width=5.4cm, minimum height=2.0cm, align=center, fill=green!15},
    central/.style={rectangle, draw, rounded corners, minimum width=7.2cm, minimum height=2.1cm, align=center, fill=yellow!20},
    arrow/.style={->, >=Stealth, thick}
]
    % Results
