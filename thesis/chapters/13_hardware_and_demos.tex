...
\texttt{generated\_opcodes.vh} & 47 & Opcode constants (generated from Coq) \\
...
\textbf{What is this code?} This is a \textbf{representative subset} of the opcode mapping for the Thiele CPU. The full ISA has 47 opcodes; this listing covers the base 30. CERTIFY (0x1E) and the seven categorical MORPH opcodes (0x1F–0x25) are defined in the full generated header. These are \textit{generated from Coq} to ensure hardware and proofs use identical encodings.
