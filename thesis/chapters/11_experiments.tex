...
\begin{tikzpicture}[scale=1.8, 
    node distance=2.5cm,
    category/.style={rectangle, draw, rounded corners, minimum width=5.5cm, minimum height=2.0cm, align=center, fill=blue!10},
    central/.style={rectangle, draw, rounded corners, minimum width=6.2cm, minimum height=2.1cm, align=center, fill=yellow!20},
...
\begin{tikzpicture}[scale=1.8, 
    node distance=2.5cm,
    attack/.style={rectangle, draw, rounded corners, minimum width=5.5cm, minimum height=2.0cm, align=center, fill=red!15},
    defense/.style={rectangle, draw, rounded corners, minimum width=5.5cm, minimum height=2.0cm, align=center, fill=green!15},
    arrow/.style={->, >=Stealth, thick}
]
    % Attacks
...
\begin{tikzpicture}[scale=1.8, 
    node distance=3cm,
    stage/.style={rectangle, draw, rounded corners, minimum width=4.5cm, minimum height=2.0cm, align=center, fill=blue!10},
    check/.style={rectangle, draw, rounded corners, minimum width=4.5cm, minimum height=2.0cm, align=center, fill=green!15, font=\normalsize},
    arrow/.style={->, >=Stealth, thick}
]
    % Stages
