...
\begin{tikzpicture}[scale=1.8, 
    node distance=3.0cm,
    category/.style={rectangle, draw, rounded corners=3pt, minimum width=5.5cm, minimum height=2.0cm, align=center, fill=blue!10},
    central/.style={rectangle, draw, rounded corners=3pt, minimum width=6.2cm, minimum height=2.1cm, align=center, fill=yellow!15},
    arrow/.style={->, >=Stealth, thick}
]
    % Categories
    \node[category, align=center, text width=4.5cm] (physics) at (-4, 1.5) {Physics\\Simulations};
    \node[category, align=center, text width=4.5cm] (falsify) at (-1.5, 2) {Falsification\\Tests};
    \node[category] (bench) at (1.5, 2) {Benchmarks};
    \node[category] (demo) at (4, 1.5) {Demonstrations};
    \node[category, align=center, text width=4.5cm] (integ) at (0, -1.5) {Integration\\Tests};
    
    % Central
    \node[central, align=center, text width=4.5cm] (theory) at (0, 0) {\textbf{Thiele Machine}\\Scientific Theory};
    ...
    % Result
    \node[draw, rounded corners=3pt, fill=green!12, font=
ormalsize, align=center, text width=4.5cm] at (0, -3) {All experiments PASS\\Theory remains unfalsified};
\end{tikzpicture}
...
\begin{tikzpicture}[scale=1.8, 
    node distance=3.0cm,
    attack/.style={rectangle, draw, rounded corners=3pt, minimum width=5.5cm, minimum height=2.0cm, align=center, fill=red!15},
    defense/.style={rectangle, draw, rounded corners=3pt, minimum width=5.5cm, minimum height=2.0cm, align=center, fill=green!15},
    arrow/.style={->, >=Stealth, thick}
]
    % Attacks
    \node[attack, align=center, text width=4.5cm] (forge) at (-3, 1.5) {Receipt\\Forgery};
    \node[attack, align=center, text width=4.5cm] (insight) at (0, 1.5) {Free Insight\\Attack};
    \node[attack, align=center, text width=4.5cm] (supra) at (3, 1.5) {Supra-Quantum\\Attack};
    ...
    % Theory
    \node[rectangle, draw, rounded corners=3pt, fill=yellow!15, minimum width=10.8cm] (theory) at (0, -1.5) {\textbf{Theory Unfalsified}};
...
\begin{tikzpicture}[scale=1.8, 
    node distance=3cm,
    stage/.style={rectangle, draw, rounded corners=3pt, minimum width=4.5cm, minimum height=2.0cm, align=center, fill=blue!10},
    check/.style={rectangle, draw, rounded corners=3pt, minimum width=4.5cm, minimum height=2.0cm, align=center, fill=green!15, font=
ormalsize},
    arrow/.style={->, >=Stealth, thick}
]
    % Stages
    \node[stage, align=center, text width=4.5cm] (build) at (0, 0) {Proof\\Build};
    \node[stage, align=center, text width=4.5cm] (admit) at (2.5, 0) {Admit\\Check};
    \node[stage, align=center, text width=4.5cm] (test) at (5, 0) {Unit\\Tests};
    \node[stage, align=center, text width=4.5cm] (iso) at (7.5, 0) {Isomorphism\\Gate};
    \node[stage, align=center, text width=4.5cm] (bench) at (10, 0) {Bench-\\marks};
    ...
    % Result
    \node[draw, rounded corners=3pt, fill=green!12] at (5, -2.5) {All checks PASS on every commit};
\end{tikzpicture}
...
\begin{tikzpicture}[scale=1.8, 
    ...
    % Results
    \node[result, align=center, text width=4.5cm] (physics) at (-3, 1.5) {Physics\\Simulated};
    \node[result, align=center, text width=4.5cm] (falsify) at (3, 1.5) {Falsification\\Attempted};
    \node[result, align=center, text width=4.5cm] (bench) at (-3, -1.5) {Benchmarks\\Measured};
    \node[result, align=center, text width=4.5cm] (ci) at (3, -1.5) {CI\\Enforced};
    
    % Central
    \node[central, align=center, text width=4.5cm] (central) at (0, 0) {\textbf{All Experiments}\\PASSED};
