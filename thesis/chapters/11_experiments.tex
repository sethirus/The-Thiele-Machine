...
\begin{lstlisting}
python3 archive/scripts_unused/structural_heat_experiment.py
python3 archive/scripts_unused/structural_heat_experiment.py --sweep-records --records-pow-min 10 --records-pow-max 20 --records-pow-step 2
\end{lstlisting}
Outputs:
\begin{itemize}
...
\textbf{Protocol (reproducible):}
\begin{lstlisting}
python3 archive/scripts_unused/time_dilation_experiment.py
\end{lstlisting}
Outputs:
\begin{itemize}
    \item A JSON file (includes run metadata and invariant checks)
