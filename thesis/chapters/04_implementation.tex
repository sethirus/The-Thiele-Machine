...
\begin{itemize}
    \item \textbf{Layer 1: Coq (blue):} Formal specification with machine-checked proofs (1,636 verified theorems)
...
\begin{enumerate}
    ...
    \item \textbf{Build Proofs (green):} Compile all 260 kernel proofs successfully
...
\textbf{Below each stage:} What is checked (e.g., "No Admitted", "260 proofs compile", "3-way state match")
...
\begin{itemize}
    \item \textbf{Coq (blue):} 1,636 theorems, machine-checked, extracted runner
