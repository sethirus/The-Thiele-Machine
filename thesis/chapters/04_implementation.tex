...
% Side annotations
\node[note, left=2.9cm of coq, align=center, text width=3.5cm, font=\small, xshift=-10pt] {Machine-checked proofs\\206 verified theorems};
\node[note, left=2.9cm of python, align=center, text width=3.5cm, font=\small, xshift=-10pt] {Human-readable\\Tracing \& debugging};
\node[note, left=2.9cm of verilog, align=center, text width=3.5cm, font=\small, xshift=-10pt] {Synthesizable RTL\\FPGA-ready};
