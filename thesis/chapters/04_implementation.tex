...
\begin{tikzpicture}[
    ...
    note/.style={font=\normalsize\itshape, text width=2.8cm, align=center},
...
% Side annotations
\node[note, left=2.9cm of coq, align=center, text width=3.5cm, sloped, pos=0.5, font=\small, xshift=-10pt] {Machine-checked proofs\\206 verified theorems};
...
\centering
\begin{tikzpicture}[
    field/.style={rectangle, draw, minimum width=5.8cm, minimum height=1.1cm, font=\normalsize},
...
\centering
\begin{tikzpicture}[
    module/.style={rectangle, draw, rounded corners, minimum width=4.6cm, minimum height=1.4cm, font=\normalsize},
    arrow/.style={->, very thick, >=stealth},
...
\centering
\begin{tikzpicture}[
    bit/.style={rectangle, draw, minimum width=0.7cm, minimum height=1.4cm, font=\normalsize},
    field/.style={rectangle, draw, very thick, minimum height=1.4cm, font=\normalsize\bfseries},
    scale=0.7, transform shape
], node distance=3cm]
...
% Bit fields
\node[field, fill=blue!20, minimum width=3.6cm] (opcode) at (0,0) {opcode};
\node[field, fill=green!20, minimum width=3.6cm] (opa) at (2.5,0) {operand\_a};
\node[field, fill=orange!20, minimum width=3.6cm] (opb) at (5,0) {operand\_b};
\node[field, fill=red!20, minimum width=3.6cm] (cost) at (7.5,0) {cost};
...
\centering
\begin{tikzpicture}[
    block/.style={rectangle, draw, minimum width=3.6cm, minimum height=1.4cm, font=\normalsize},
    arrow/.style={->, very thick, >=stealth},
    scale=0.7, transform shape
], node distance=3cm]
% Input signals
...
% Operations list
\node[draw, rounded corners, fill=yellow!10, text width=2.5cm, align=left, font=\normalsize, align=center] at (1,-2.5) {
    0: ADD\\
    1: SUB\\
    2: MUL\\
    3: DIV\\
...
\node[font=\normalsize, text width=2cm, align=center, below=0.5cm of build, sloped, pos=0.5, font=\small, yshift=-6pt] {206 proofs\\compile\\successfully};
\node[font=\normalsize, text width=2cm, align=center, below=0.5cm of iso, sloped, pos=0.5, font=\small, yshift=-6pt] {3-way\\state match};
\node[font=\normalsize, text width=2cm, align=center, below=0.5cm of report, sloped, pos=0.5, font=\small, yshift=-6pt] {HIGH: 0\\MEDIUM: 2\\LOW: 4};
