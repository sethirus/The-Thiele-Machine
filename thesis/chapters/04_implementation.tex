...
\begin{itemize}
    \item \textbf{Layer 1: Coq (blue):} Formal specification with machine-checked proofs (1,637 verified theorems)
...
\begin{itemize}
    \item \textbf{Coq (blue):} 1,637 theorems, machine-checked, extracted runner
