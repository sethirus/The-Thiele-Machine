...
\begin{quote}
\textit{Author's Note (Devon): I'm going to be real with you---when I first got all three layers to agree on a non-trivial computation, I cried. Like, actually cried. For probably fifteen minutes. Because it meant the thing I built in my head wasn't just a fever dream. It was \textbf{real}. The math shop agreed with the Python shop agreed with the hardware shop. That's when I knew I had something.}
\end{quote}
