...
\centering
\begin{tikzpicture}[
    layer/.style={rectangle, draw, rounded corners, minimum width=6.2cm, minimum height=2.1cm, font=\normalsize\bfseries},
...
\centering
\begin{tikzpicture}[
    module/.style={rectangle, draw, rounded corners, minimum width=5.5cm, minimum height=2.0cm, font=\normalsize},
    arrow/.style={->, very thick, >=stealth},
    scale=1.0
, node distance=3cm]
% Top-level CPU
...
% External interface
\node[module, fill=gray!20, align=center, text width=4.5cm, font=\normalsize] (z3) at (5,1) {Z3 \\ External};
...
% ALU wait states
\node[state, fill=gray!20, align=center, text width=4.5cm, font=\normalsize] (aluwait) at (0,-2) {ALU\\WAIT};
...
\begin{tikzpicture}[
    ...
    field/.style={rectangle, draw, very thick, minimum height=2.0cm, font=\normalsize\bfseries},
    scale=1.0
, node distance=3cm]
...
% Bit fields
\node[field, fill=blue!20, minimum width=4.5cm] (opcode) at (0,0) {opcode};
\node[field, fill=green!20, minimum width=4.5cm] (opa) at (2.5,0) {operand\_a};
\node[field, fill=orange!20, minimum width=4.5cm] (opb) at (5,0) {operand\_b};
\node[field, fill=red!20, minimum width=4.5cm] (cost) at (7.5,0) {cost};
...
% Operations list
\node[draw, rounded corners, fill=yellow!10, text width=4.5cm, align=left, font=\normalsize, align=center] at (1,-2.5) {
    0: ADD\\
    1: SUB\\
    2: MUL\\
    3: DIV\\
...
\centering
\begin{tikzpicture}[
    layer/.style={rectangle, draw, rounded corners, minimum width=5.5cm, minimum height=2.1cm, font=\normalsize},
    arrow/.style={->, very thick, >=stealth},
...
\node[layer, fill=blue!20, align=center, text width=4.5cm] (coq) at (-3,-2) {Coq\\Extracted};
\node[layer, fill=green!20, align=center, text width=4.5cm] (python) at (0,-2) {Python\\VM};
...
\centering
\begin{tikzpicture}[
    stage/.style={rectangle, draw, rounded corners, minimum width=5.5cm, minimum height=2.1cm, font=\normalsize},
    check/.style={diamond, draw, fill=yellow!20, minimum size=0.8cm, font=\normalsize},
    arrow/.style={->, very thick, >=stealth},
    scale=1.05
, node distance=3cm]
% Stages
\node[stage, fill=blue!20, align=center, text width=4.5cm] (scan) at (0,0) {Scan\\Sources};
\node[stage, fill=green!20, align=center, text width=4.5cm] (build) at (3,0) {Build\\Proofs};
