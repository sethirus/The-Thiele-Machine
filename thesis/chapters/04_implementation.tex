...
\draw[<->, thick, blue!60] (coq.south) +(-1.2,0) -- +(-1.2,-0.58) node[midway, left, font=\scriptsize] {Bisim};
...
\begin{itemize}
    \item \textbf{Slow}: Extracted code isn't optimized (e.g., nat as int wrapper)
