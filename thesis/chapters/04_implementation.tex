...
\subsection{Building Trust Through Multi-Layer Verification}
...
This is why the system was built three times: one implementation in pure mathematics (Coq), one in Python for reference and debugging, and one in Verilog for actual hardware. All three must produce identical results.

If all three implementations agree, the model is verified. If they disagree, there's a bug to find.
