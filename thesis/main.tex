...
This thesis presents the \textbf{Thiele Machine}, a formal model of computation that treats structural information as a costly resource.
...
\textbf{What is proven} (in Coq, with zero admits and documented axioms):
\begin{itemize}
...
The project is open source and documented. The proofs stand or fall on their own merits.
