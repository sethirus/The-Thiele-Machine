...
I am not a computer scientist. I have no formal training in mathematics, physics, or programming. I'm a car salesman who taught himself to build with modern tools (including AI assistance) and stubborn curiosity. Everything here---the full Coq proof corpus, machine-checked theorems, a working VM with assembler and debugger, synthesizable hardware with FPGA bitstreams, a Coq-to-Verilog extraction pipeline through Kami---was built through persistence, not credentials. I mention this because it matters: the proofs compile or they don't. They don't care who wrote them.
...
\begin{itemize}
    ...
    \item \textbf{Oracle Impossibility}: No finite oracle can resolve all $\mu$-bounded halting questions---proven in \path{coq/kernel/OracleImpossibility.v}.
    \item \textbf{Turing Machine Reduction}: A direct Minsky-machine embedding proves Thiele subsumes Turing---\path{coq/modular_proofs/TM_to_Minsky.v}.
\end{itemize}

\textbf{What is built}:
\begin{itemize}
    \item Coq formal kernel and extensions (319 files, 93,451 lines, zero admits, zero custom axioms)
    \item Python reference VM with cryptographic receipts, two-pass assembler, and interactive debugger
    \item Synthesizable Verilog RTL extracted from Coq through Kami, with ECP5 and iCE40 FPGA bitstreams
    \item 1,012 automated test functions across 120 test files enforcing 3-layer isomorphism
