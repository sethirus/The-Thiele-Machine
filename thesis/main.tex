...
\begin{itemize}
    ...
    \item \textbf{Turing Subsumption}: A direct simulation proof shows Thiele strictly extends Turing, with cost certificates that Turing machines cannot produce---\path{coq/kernel/TuringStrictness.v} (\texttt{D5\_thiele\_strictly\_extends\_classical}).
\end{itemize}
