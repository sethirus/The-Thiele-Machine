...
This thesis presents the \textbf{Thiele Machine}, a formal model of computation that treats structural information as a costly resource. I built it by asking questions I couldn't answer and pulling on threads until they led somewhere real.
...
\textbf{What I proved} (in Coq, with zero admits and zero axioms):
\begin{itemize}
