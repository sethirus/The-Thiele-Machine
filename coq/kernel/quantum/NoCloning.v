...
*)
(** Substituting the perfect-deletion equalities (output = input1,
    input1 = input2) into the conservation inequality leaves
    [del_mu_cost >= del_input1_info]. Definition-with-ltac form. *)
