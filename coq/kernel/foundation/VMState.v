...
(** Morphisms are arrows between modules.
    ...
    manipulate this categorical structure directly. *)
...
(** The morphism opcodes (MORPH, COMPOSE, MORPH_ID, MORPH_DELETE,
    MORPH_TENSOR) touch [pg_morphisms] and [pg_next_morph_id] only.
    None of them touch [pg_modules], so [graph_lookup], which reads
    [pg_modules], is unaffected.
