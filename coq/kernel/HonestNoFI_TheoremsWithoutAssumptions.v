...
(** Observation-level packaging for shortcuts that carry posterior
    admissibility in the receipt-observation sense but do not yet claim a
    cert_addr witness. This is the honest class for EMIT-style factorization
    stories before they have been bridged into the stronger certification
    channel. *)
