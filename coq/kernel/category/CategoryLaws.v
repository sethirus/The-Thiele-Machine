...
(** Pointwise [iff] reflexivity is immediate from [Iff.iff_refl].  The
    symmetry and transitivity lemmas below are retained because downstream
    rewriting chains use them. *)
