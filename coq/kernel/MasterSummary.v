...
(* AUDIT:
  ...
  premise_kinds: syntactic
  new_content_here: none; legacy compatibility alias only
  semantic_layer: formal theorem layer
  external_interpretation: prefer the audit-facing name thiele_machine_core_summary_verified
*)
(** Theorem 10b: Legacy compatibility alias for the core summary bundle. *)
...
(** =========================================================================
    ...
    MORPH_DELETE, MORPH_ASSERT, MORPH_TENSOR, MORPH_GET) satisfy category laws
    and the NoFreeInsight cost policy.
