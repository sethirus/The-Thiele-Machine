...
(** Physical constants defined in normalized units.
    These are chosen to be positive rationals for proof automation compatibility.
    The positivity lemmas are then derived mathematically from these concrete values. *)
