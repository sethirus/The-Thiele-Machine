...
Definition opcode_LOAD_IMM  : N := 8%N.
...
Definition opcode_LOAD      : N := 17%N.
Definition opcode_STORE     : N := 18%N.
Definition opcode_ADD       : N := 19%N.
Definition opcode_SUB       : N := 20%N.
Definition opcode_JUMP      : N := 21%N.
