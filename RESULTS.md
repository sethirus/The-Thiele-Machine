...
The scheduled `proofpack-smoke` workflow runs `make proofpack-smoke`, publishes the manifest digest in the GitHub Actions summary, and writes the latest row into this table via `scripts/update_smoke_digest.py`.
