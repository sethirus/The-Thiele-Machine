# INQUISITOR REPORT
Generated: 2026-03-09 22:05:22Z (UTC)
...
#### `coq/kernel/MuLedgerQuantumBridge.v`
- L366: **PHYSICS_ANALOGY_CONTRACT** — Physics-analogy theorem lacks invariance lemma and is not labeled definitional.
  - `Theorem mu_ledger_coherent_implies_tsirelson_bound_squared :`
- L382: **PHYSICS_ANALOGY_CONTRACT** — Physics-analogy theorem lacks invariance lemma and is not labeled definitional.
  - `Theorem mu_ledger_coherent_implies_tsirelson_bound_abs :`

#### `coq/thielemachine/coqproofs/ThieleVMOpcodes.v`
- L1: **PROOF_BODY_FOUNDATION_DISCONNECT** — File is disconnected from canonical kernel foundations in theorem-body dependency graph. Add constructive bridge lemmas/uses until it transitively reaches VMState/VMStep/MuCostModel/MuLedgerConservation/NoFreeInsight/MuInitiality.
  - ``

#### `thielecpu/hardware/cosim.py`
- L1: **CROSS_LAYER_FOUNDATION_DISCONNECT** — Required cross-layer artifact is missing.
  - ``
