...
module mkModule1 (Module1);
    ...
    rule step;
        ...
        Bit#(32) x_72 = ((x_5)[x_69]);
        Bit#(32) x_73 = ((x_5)[x_71]);
        ...
        Bit#(32) x_108 = ((x_83 ? ((x_5)[x_78]) : ((Bit#(32))'(32'h0))));
        ...
        Vector#(65536, Bit#(32)) x_162 = ((((((x_48) || (x_92)) || (x_102))
        || (x_95)) || (x_154) ? (x_5) : (((x_51) == ((Bit#(8))'(8'h12)) ?
        (update (x_5, x_70, x_67)) : (((x_51) == ((Bit#(8))'(8'h17)) ?
        (update (x_5, x_75, x_57)) : (((x_51) == ((Bit#(8))'(8'h1d)) ?
        (update (x_5, x_70, x_67)) : (x_5)))))))));
    ...
    method ActionValue#(Bool) apbWrite (Struct2 x_0);
        ...
        Bool x_21 = ((x_11) && (x_17));
        Vector#(65536, Bit#(32)) x_22 = ((x_21 ? (update (x_1, x_18, x_19)) :
        (x_1)));
