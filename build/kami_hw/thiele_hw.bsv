...
module mkModule1 (Module1);
    ...
    Reg#(Vector#(4096, Bit#(32))) imem <- mkReg(unpack(0));
    ...
    rule step;
        ...
        Vector#(4096, Bit#(32)) x_173 = ((((((x_55) || (x_99)) || (x_109)) ||
        (x_102)) || (x_165) ? (x_6) : (((x_58) == ((Bit#(8))'(8'h12)) ?
    ...
    method ActionValue#(Bool) apbWrite (Struct3 x_0);
        ...
        Bool x_27 = ((x_14) && (x_23));
        Vector#(4096, Bit#(32)) x_28 = ((x_27 ? (update (x_1, x_24, x_25)) :
        (x_1)));
