...
module mkModule1 (Module1);
    ...
    Reg#(Vector#(65536, Bit#(32))) imem <- mkReg(unpack(0));
    ...
    rule step;
        ...
        Bit#(32) x_79 = ((x_6)[x_76]);
        Bit#(32) x_80 = ((x_6)[x_78]);
        ...
        Bit#(32) x_115 = ((x_90 ? ((x_6)[x_85]) : ((Bit#(32))'(32'h0))));
        ...
        Vector#(65536, Bit#(32)) x_175 = ((((((x_55) || (x_99)) || (x_109))
        || (x_102)) || (x_167) ? (x_6) : (((x_58) == ((Bit#(8))'(8'h12)) ?
        (update (x_6, x_77, x_74)) : (((x_58) == ((Bit#(8))'(8'h17)) ?
        (update (x_6, x_82, x_64)) : (((x_58) == ((Bit#(8))'(8'h1d)) ?
        (update (x_6, x_77, x_74)) : (x_6)))))))));
    ...
    method ActionValue#(Bool) apbWrite (Struct3 x_0);
        ...
        Bool x_27 = ((x_14) && (x_23));
        Vector#(65536, Bit#(32)) x_28 = ((x_27 ? (update (x_1, x_24, x_25)) :
        (x_1)));
