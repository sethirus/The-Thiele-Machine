# INQUISITOR REPORT
Generated: 2026-02-09 23:55:43Z (UTC)
Scanned: 278 Coq files across the repo
## Summary
- HIGH: 0
- MEDIUM: 0
- LOW: 69
...
- L96: **AXIOM_DOCUMENTED** — Found Axiom quantum_CHSH_bound.
  - `Axiom quantum_CHSH_bound : forall (npa : NPAMomentMatrix),`
- L134: **AXIOM_DOCUMENTED** — Found Axiom optimal_is_quantum_realizable.
  - `Axiom optimal_is_quantum_realizable :`
- L256: **CHSH_BOUND_MISSING** — CHSH bound theorem \`classical_CHSH_bound\` may not reference proper Tsirelson bound value.
  - `Lemma classical_CHSH_bound : forall (npa : NPAMomentMatrix),`
- L343: **AXIOM_DOCUMENTED** — Found Axiom grothendieck_constant.
  - `Axiom grothendieck_constant : R.`
- L344: **AXIOM_DOCUMENTED** — Found Axiom grothendieck_value.
  - `Axiom grothendieck_value : 1.7 < grothendieck_constant < 1.8.`
- L345: **AXIOM_DOCUMENTED** — Found Axiom grothendieck_inequality.
  - `Axiom grothendieck_inequality : forall (npa : NPAMomentMatrix),`

#### `archive/kernel_exploratory/MinorConstraints.v`
- L202: **AXIOM_DOCUMENTED** — Found Axiom Fine_theorem.
  - `Axiom Fine_theorem : forall E00 E01 E10 E11 s t,`
- L265: **CHSH_BOUND_MISSING** — CHSH bound theorem \`minor_constraints_imply_CHSH_bound\` may not reference proper Tsirelson bound value.
  - `Theorem minor_constraints_imply_CHSH_bound : forall E00 E01 E10 E11,`
- L363: **AXIOM_DOCUMENTED** — Found Axiom Gram_PSD.
  - `Axiom Gram_PSD : forall (s e1 e2 : R),`
- L434: **AXIOM_DOCUMENTED** — Found Axiom local_box_satisfies_minors.
  - `Axiom local_box_satisfies_minors : forall B,`

#### `archive/kernel_exploratory/MuInformationTheoreticBounds.v`
...
#### `archive/kernel_exploratory/QuantumBoundComplete.v`
...
#### `archive/kernel_exploratory/TsirelsonBoundComplete.v`
...
#### `archive/kernel_exploratory/TsirelsonBoundProof2.v`
...
#### `archive/kernel_exploratory/TsirelsonBoundTDD.v`
...
#### `archive/kernel_exploratory/TsirelsonBoundVerification.v`
- L212: **AXIOM_DOCUMENTED** — Found Axiom config_111_0_not_psd_axiom.
  - `Axiom config_111_0_not_psd_axiom :`

#### `coq/kernel/AlgebraicCoherence.v`
- L522: **CHSH_BOUND_MISSING** — CHSH bound theorem \`chsh_weak_bound\` may not reference proper Tsirelson bound value.
  - `Lemma chsh_weak_bound : forall e00 e01 e10 e11 : Q,`
- L586: **CHSH_BOUND_MISSING** — CHSH bound theorem \`chsh_squared_bound_from_correlations\` may not reference proper Tsirelson bound value.
  - `Lemma chsh_squared_bound_from_correlations : forall e00 e01 e10 e11 : Q,`

#### `coq/kernel/MinorConstraints.v`
- L627: **CHSH_BOUND_MISSING** — CHSH bound theorem \`deterministic_strategy_chsh_bounded\` may not reference proper Tsirelson bound value.
...
- L81: **CONTEXT_ASSUMPTION_DOCUMENTED** — Context parameter \`tsirelson_from_algebraic_coherence\` is documented with INQUISITOR NOTE.
