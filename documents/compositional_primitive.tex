% Status update (October 2025): Formal proof complete. This process-calculus formalization of the compositional primitive is validated by the complete Coq simulation proof in coq/kernel/SimulationProof.v. See docs/operation_unification_progress.md for the current evidence base.
