% Status update (October 2025): This process-calculus formalization aligns with the kernel bridge currently under development. The Coq simulation proof in `coq/kernel/SimulationProof.v` still contains admitted lemmas tracked in `coq/ADMIT_REPORT.txt`; see the audit logs for the latest build evidence.
