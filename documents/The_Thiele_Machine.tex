% Status update (October 2025, refreshed): historical narrative retained for context. The complete VM↔kernel simulation framework is now proven. See README.md, BELL_INEQUALITY_VERIFIED_RESULTS.md, and coq/kernel/SimulationProof.v together with coq/ADMIT_REPORT.txt for the current evidence base.
