% Status update (October 2025): historical narrative retained for context. The complete VM↔kernel simulation framework is now proven. See docs/kernel_analysis.md, docs/final_fact_check.md, and coq/kernel/SimulationProof.v for the current evidence base.
