...
# Aliases for cross-layer isomorphism (matches Coq opcode_* and RTL OPCODE_* naming)
OPCODE_PNEW = OP_PNEW
OPCODE_PSPLIT = OP_PSPLIT
OPCODE_PMERGE = OP_PMERGE
OPCODE_LASSERT = OP_LASSERT
OPCODE_LJOIN = OP_LJOIN
OPCODE_MDLACC = OP_MDLACC
OPCODE_PDISCOVER = OP_PDISCOVER
OPCODE_XFER = OP_XFER
OPCODE_PYEXEC = OP_PYEXEC
OPCODE_CHSH_TRIAL = OP_CHSH_TRIAL
OPCODE_XOR_LOAD = OP_XOR_LOAD
OPCODE_XOR_ADD = OP_XOR_ADD
OPCODE_XOR_SWAP = OP_XOR_SWAP
OPCODE_XOR_RANK = OP_XOR_RANK
OPCODE_EMIT = OP_EMIT
OPCODE_REVEAL = OP_REVEAL
OPCODE_ORACLE_HALTS = OP_ORACLE
OPCODE_HALT = OP_HALT
