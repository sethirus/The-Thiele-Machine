...
class TestISAV2ArtifactFreshness:
    ...
    def test_vm_py_has_all_47_opcodes(self):
        """thielecpu/vm.py must reference all 47 synth-realised opcode names (cosim OPCODES)."""
    ...
    def test_thiele_core_ml_has_47_constructors(self):
        """build/thiele_core.ml must contain all 47 synth-realised vm_instruction constructors (cosim OPCODES)."""
