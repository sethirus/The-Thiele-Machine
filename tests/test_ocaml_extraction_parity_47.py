#!/usr/bin/env python3
"""Exhaustive OCaml extraction parity test — all 47 opcodes.

WHAT THIS TESTS:
  For each of the 47 vm_instruction constructors in coq/kernel/VMStep.v:
...
class TestMuMonotonicityInvariant:
    """Verify that mu is nondecreasing across all 47 opcodes.
...
class TestCoverageCompleteness:
    """Verify that this test file covers all 47 canonical opcode names."""
